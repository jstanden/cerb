<?php /* Smarty version 2.6.14, created on 2006-11-20 16:38:37
         compiled from file:C:%5Capachefriends%5Cxampp%5Cxampp%5Chtdocs%5Ccerb4%5Cplugins%5Ccom.cerberusweb.core/templates/dashboards/index.tpl.php */ ?>
...
unset($_smarty_tpl_vars);
 ?>
      ...
      <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "file:".($this->_tpl_vars['path'])."/dashboards/ticket_view.tpl.php", 'smarty_include_vars' => array('id' => '1')));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
      <br>
      <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "file:".($this->_tpl_vars['path'])."/dashboards/ticket_view.tpl.php", 'smarty_include_vars' => array('id' => '2')));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
      <br>
      <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "file:".($this->_tpl_vars['path'])."/dashboards/ticket_view.tpl.php", 'smarty_include_vars' => array('id' => '3')));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
      <br>
      <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "file:".($this->_tpl_vars['path'])."/dashboards/ticket_view.tpl.php", 'smarty_include_vars' => array('id' => '4')));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
      <br>
      <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "file:".($this->_tpl_vars['path'])."/dashboards/ticket_view.tpl.php", 'smarty_include_vars' => array('id' => '5')));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
      <br>
