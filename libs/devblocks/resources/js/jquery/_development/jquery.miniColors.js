		...
		miniColors: function(o, data) {
			...
			var create = function(input, o, data) {
				...
				input
					...
					.data('hsb', hsb)
					.data('color-favorites', o.color_favorites)
			...
			var show = function(input) {
				...
				selector
					...
					.append('<div class="miniColors-colorFavorites"></div>')
					.css({
				...
				// Favorites
				var colorFavorites = selector.find('.miniColors-colorFavorites');
				var favorites = input.data('color-favorites');
				
				if(typeof favorites == "object" && favorites.length > 0)
					selector.css('height', '170px');
				
				for(idx in favorites) {
					var swatch = $('<div class="miniColors-colorFavorite"></div>')
						.data('favorite-color', favorites[idx])
						.css('background-color', favorites[idx])
						.bind('click', function(e) {
							input.val($(this).data('favorite-color'));
							setColorFromInput(input);
						})
						;
					
					colorFavorites.append(swatch);
				}
