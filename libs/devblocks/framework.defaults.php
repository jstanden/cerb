...
if(!defined('DEVBLOCKS_CACHE_ENGINE_PREVENT_CHANGE'))
	define('DEVBLOCKS_CACHE_ENGINE_PREVENT_CHANGE', defined('CERB_CLOUD_SUBDOMAIN'));
...
if(!defined('DEVBLOCKS_STORAGE_ENGINE_PREVENT_CHANGE'))
	define('DEVBLOCKS_STORAGE_ENGINE_PREVENT_CHANGE', defined('CERB_CLOUD_SUBDOMAIN'));
...
if(!defined('APP_SECURITY_ALLOW_ADMIN_SESSION_TOKEN'))
	define('APP_SECURITY_ALLOW_ADMIN_SESSION_TOKEN', true);
...
if(!defined('APP_OPT_PARSER_ATTACHMENT_DUPE_WITH_FILENAME'))
	define('APP_OPT_PARSER_ATTACHMENT_DUPE_WITH_FILENAME', false);
