<table cellpadding="0" cellspacing="0" border="0" class="tableOrange" width="220" class="tableBg">
	<tr>
		<td class="tableThOrange" nowrap="nowrap"> <img src="{$smarty.const.DEVBLOCKS_WEBPATH}images/businessmen.gif"> {$translate->say('dashboard.team_loads')|capitalize}</td>
	</tr>
	<tr>
		<td>
			<table cellpadding="0" cellspacing="1" border="0" width="100%" class="tableBg">
				{foreach from=$teams item=team}
					...
					{/if}
				<tr>
					<td class="tableCellBg" width="100%" style="padding:2px;"><a href="{$smarty.const.DEVBLOCKS_WEBPATH}index.php?c=core.module.dashboard&a=clickteam&id={$team->id}"><b>{$team->name}</b></a> ({$team->count})</td>
