<table cellpadding="0" cellspacing="0" border="0" class="tableBlue" width="100%" class="tableBg">
	<tr>
		...
		<td nowrap="nowrap" class="tableThBlue" align="right"><a href="#" onclick="" class="tableThLink">refresh</a><span style="font-size:12px"> | </span><a href="javascript:;" class="tableThLink">search</a><span style="font-size:12px"> | </span><a href="javascript:;" onclick="getCustomize({$id});" class="tableThLink">customize</a></td>
	</tr>
</table>
