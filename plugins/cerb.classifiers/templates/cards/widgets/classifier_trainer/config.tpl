...
<div id="cardWidgetConfig{$config_uniqid}" style="margin-top:10px;">
    <fieldset class="peek">
        ...
        <b><a class="cerb-chooser" data-context="{CerberusContexts::CONTEXT_CLASSIFIER}" data-single="true">ID</a>:</b>
...
$(function() {
    ...
    if(window.CerbUI && CerbUI.RecordChooser) CerbUI.RecordChooser.pickerLink($config.find('.cerb-chooser')[0], { input: $input_classifier_id });
});
</script>