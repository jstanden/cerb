							...
							{elseif $param_type == 'contact'}
								...
								{foreach from=$param.$k item=contact}
									<li>
										...
										<a class="cerb-peek-trigger" data-context="{CerberusContexts::CONTEXT_CONTACT}" data-context-id="{$contact.id}">{$contact.full_name}</a>
									</li>
								{/foreach}
								</ul>
							{elseif $param_type == 'context'}
							...
							{elseif $param_type == 'worker'}
								...
								{foreach from=$param.$k item=worker}
									<li>
										...
										<a class="cerb-peek-trigger" data-context="{CerberusContexts::CONTEXT_WORKER}" data-context-id="{$worker.id}">{$worker.full_name}</a>
									</li>
								{/foreach}
								</ul>
							{else}
