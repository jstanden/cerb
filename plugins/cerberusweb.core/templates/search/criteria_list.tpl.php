<table cellpadding="2" cellspacing="0" width="200" border="0" class="tableGreen">
	...
	<tr style="border-bottom:1px solid rgb(200,200,200);">
		<td>
			...
			{/if}
			<a href="{devblocks_url}c=search&a=resetCriteria{/devblocks_url}">reset</a> |
			...
			<table cellpadding="2" cellspacing="0" border="0">
				...
				{foreach from=$params item=param}
					<tr>
						...
						<td width="0%" nowrap="nowrap" valign="top"><a href="{devblocks_url}c=search&a=removeCriteria&field={$param->field}{/devblocks_url}"><img src="{devblocks_url}images/data_error.gif{/devblocks_url}" border="0" align="absmiddle"></a></td>
					</tr>
				{/foreach}
				{/if}
			</table>
