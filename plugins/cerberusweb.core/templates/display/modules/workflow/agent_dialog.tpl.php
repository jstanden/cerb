<table cellpadding="0" cellspacing="0" border="0" width="98%">
	<tr>
		<td align="left" width="0%" nowrap="nowrap"><img src="{devblocks_url}images/businessman2.gif{/devblocks_url}" align="absmiddle"><img src="spacer.gif" width="5" height="1"></td>
...
<form method="POST" action="javascript:;" id="agentForm">
	...
	<br>
	<input type="button" value="{$translate->_('common.save_changes')}" onclick="displayAjax.postShowAgent();">
</form>