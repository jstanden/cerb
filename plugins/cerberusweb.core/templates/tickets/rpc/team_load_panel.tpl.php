...
<div style="height:300px;overflow:auto;background-color:rgb(247, 247, 255);border:1px solid rgb(230,230,230);margin:2px;padding:3px;">
	<table cellpadding="0" cellspacing="0" border="0" width="100%">
		{foreach from=$teams item=team}
			...
			{/if}
		<tr>
			<td class="tableCellBg" width="100%" style="padding:2px;"><a href="{devblocks_url}c=tickets&a=dashboards&t=team&id={$team->id}{/devblocks_url}"><b>{$team->name}</b></a> ({$team->count})</td>
