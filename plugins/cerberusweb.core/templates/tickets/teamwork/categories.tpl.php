		...
		<td class="tableCellBg" width="100%" style="padding:2px;">
			<table cellpadding="0" cellspacing="0" border="0" width="100%">
				{foreach from=$teams item=team}
					...
					{/if}
				<tr>
					<td class="tableCellBg" width="100%"><label><input type="checkbox" name="" value=""> Category Name (0)</label></td>
				...
				{foreachelse}
				<tr>
					<td colspan="2" class="tableCellBg">{$translate->_('teamwork.no_folders')}</td>
				</tr>
				{/foreach}
			</table>
			<div align="right">
