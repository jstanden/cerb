<table cellpadding="2" cellspacing="0" border="0">
	<tr>
		<td colspan="2">
			...
			{else}
			<h3>Mailbox '{$pop3_account->nickname}'</h3>
	...
	<tr>
		...
		<td width="100%"><label style="background-color:rgb(255,220,220);"><input type="checkbox" name="delete[]" value="{$pop3_account->id}"> Delete this mailbox</label></td>
	</tr>
	{/if}
