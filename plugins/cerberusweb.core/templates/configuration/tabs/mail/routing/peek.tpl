...
{* Get Address Fields *}
{include file="file:$core_tpl/groups/manage/filters/peek_get_custom_fields.tpl" fields=$address_fields filter=$rule divName="divGetAddyFields" label="Sender address"}

{* Get Org Fields *}
{include file="file:$core_tpl/groups/manage/filters/peek_get_custom_fields.tpl" fields=$org_fields filter=$rule divName="divGetOrgFields" label="Sender organization"}
...
{* Set Ticket Fields *}
{include file="file:$core_tpl/groups/manage/filters/peek_set_custom_fields.tpl" fields=$ticket_fields filter=$rule divName="divSetTicketFields" label="Set ticket custom fields"}
