<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tbody>
    <tr>
      ...
      <td nowrap="nowrap" width="0%"><img src="{devblocks_url}images/spacer.gif{/devblocks_url}" width="10">
      	<a href="{devblocks_url}c=dashboard&a=addView{/devblocks_url}">{$translate->say('dashboard.add_view')|lower}</a> | 
      	...
      	<a href="{devblocks_url}c=dashboard{/devblocks_url}">{$translate->say('common.refresh')|lower}</a></td>
