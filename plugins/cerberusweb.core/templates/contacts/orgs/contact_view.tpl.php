...
<table cellpadding="0" cellspacing="0" border="0" width="100%" class="tableRowBg">
	...
	<tr class="tableTh">
		...
		{foreach from=$view->view_columns item=header name=headers}
			...
			<th nowrap="nowrap">
			{if $header=="c_id"}<a href="javascript:;" onclick="genericAjaxGet('view{$view->id}','c=contacts&a=viewSortBy&id={$view->id}&sortBy=c_id');">{$translate->_('contact_org.id')|capitalize}</a>
