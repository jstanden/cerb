...
<blockquote style="margin:5px;">
	...
	-and-<br>
	<input type="text" name="to" size="16" value="today"><button type="button" onclick="ajax.getDateChooser('dateSearchTo',this.form.to);">&nbsp;<img src="{devblocks_url}c=resource&p=cerberusweb.core&f=images/calendar.gif{/devblocks_url}" align="top">&nbsp;</button><br>
