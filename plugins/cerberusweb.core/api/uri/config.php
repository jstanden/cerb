...
//	}
	...
	function showKbImportPanelAction() {
		...
		$tpl->display('file:' . $this->_TPL_PATH . 'configuration/tabs/kb/import.tpl');
	}
...
//	}
	...
	function showTabKbAction() {
		...
		$tpl->display('file:' . $this->_TPL_PATH . 'configuration/tabs/kb/index.tpl');
	}
	...
	function getKBCategoryAction() {
		...
		$tpl->display('file:' . $this->_TPL_PATH . 'configuration/tabs/kb/edit_category.tpl');
...
//		$tpl->assign('points', $points);
	...
	function showFnrTopicPanelAction() {
		...
		$tpl->display('file:' . $this->_TPL_PATH . 'configuration/tabs/fnr/topic_panel.tpl');
	}
	...
	function showFnrResourcePanelAction() {
		...
		$tpl->display('file:' . $this->_TPL_PATH . 'configuration/tabs/fnr/external_resource_panel.tpl');
	}
