...
//		$tpl->assign('txt_name', $txt_name);
	...
	function doReplyKbSearchAction() {
		...
		$tpl->display('file:' . $this->_TPL_PATH . 'display/rpc/reply_kb_results.tpl');
	}
	...
	function showFnrPanelAction() {
		...
		$tpl->display('file:' . $this->_TPL_PATH . 'display/rpc/reply_links_panel.tpl');
	}
	...
	function doFnrAction() {
		...
		$tpl->display('file:' . $this->_TPL_PATH . 'display/modules/fnr/results.tpl');
	}
};
