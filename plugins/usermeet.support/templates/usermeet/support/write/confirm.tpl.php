  ...
  <tbody>
    ...
    <tr>
      <td colspan="2">
		...
		<button type="button" onclick="document.location='{devblocks_url}{/devblocks_url}';"><img src="{devblocks_url}c=resource&p=usermeet.support&f=images/check.gif{/devblocks_url}" align="top" border="0"> OK</button>
