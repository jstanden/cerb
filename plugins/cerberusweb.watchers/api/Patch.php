 ...
 */
class ChWatchersPatchContainer extends DevblocksPatchContainerExtension {
	function __construct($manifest) {
		...
		$this->registerPatch(new DevblocksPatch('cerberusweb.watchers',1,$file_prefix.'/1.0.0.php',''));
	}
};
