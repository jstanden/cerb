...
/* Cerb SVG icons -- served as a same-origin sprite to satisfy the portal's stricter   */
/* CSP (img-src 'self'; no data:). One SVG sprite (15 cells x 24px) in resources/icons/; */
/* each icon is selected with mask-position and painted via background-color:currentColor */
/* so it inherits the surrounding text color (matches the data:-URI icons in core).      */
.cerb-icons {
  width: 1em;
  height: 1em;
...
.cerb-icons[class*="cerb-icon-"] {
  -webkit-mask-image: url("{devblocks_url}c=resource&p=cerberusweb.support_center&f=icons/cerb-icons-sprite.svg{/devblocks_url}");
  mask-image: url("{devblocks_url}c=resource&p=cerberusweb.support_center&f=icons/cerb-icons-sprite.svg{/devblocks_url}");
...
.cerb-icon-antenna { -webkit-mask-position: 0% center; mask-position: 0% center; }
.cerb-icon-circle-ok { -webkit-mask-position: 6.666667% center; mask-position: 6.666667% center; }
.cerb-icon-circle-plus { -webkit-mask-position: 13.333333% center; mask-position: 13.333333% center; }
.cerb-icon-circle-remove { -webkit-mask-position: 20% center; mask-position: 20% center; }
.cerb-icon-clock { -webkit-mask-position: 26.666667% center; mask-position: 26.666667% center; }
.cerb-icon-erase { -webkit-mask-position: 33.333333% center; mask-position: 33.333333% center; }
.cerb-icon-file { -webkit-mask-position: 40% center; mask-position: 40% center; }
.cerb-icon-gear { -webkit-mask-position: 46.666667% center; mask-position: 46.666667% center; }
.cerb-icon-paperclip { -webkit-mask-position: 53.333333% center; mask-position: 53.333333% center; }
.cerb-icon-refresh { -webkit-mask-position: 60% center; mask-position: 60% center; }
.cerb-icon-send { -webkit-mask-position: 66.666667% center; mask-position: 66.666667% center; }
.cerb-icon-share { -webkit-mask-position: 73.333333% center; mask-position: 73.333333% center; }
.cerb-icon-sort-asc { -webkit-mask-position: 80% center; mask-position: 80% center; }
.cerb-icon-sort-desc { -webkit-mask-position: 86.666667% center; mask-position: 86.666667% center; }
.cerb-icon-zoom-in { -webkit-mask-position: 93.333333% center; mask-position: 93.333333% center; }
.cerb-icon-zoom-out { -webkit-mask-position: 100% center; mask-position: 100% center; }
