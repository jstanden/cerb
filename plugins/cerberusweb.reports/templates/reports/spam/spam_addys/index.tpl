	...
	<tr>
		<td width="50%" align="center" valign="top">
			...
			<table cellpadding="5" cellspacing="0">
				...
				<tr>
					<td><a href="javascript:;" onclick="genericAjaxPanel('c=contacts&a=showAddressPeek&email={$email|escape:'javascript'}&view_id={$view->id}',this,false,'500px',ajax.cbAddressPeek);" title="{$email|escape}">{$email|truncate:45|escape}</td>
