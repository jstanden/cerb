...
function drawChart() {{/literal}
	...
	var cObj = YAHOO.util.Connect.asyncRequest('GET', "{/literal}{devblocks_url}ajax.php?c=reports&a=action&extid=report.tickets.open_tickets&extid_a=getOpenTicketsChart{/devblocks_url}{literal}&countonly=1", {
		success: function(o) {
			...
			var myXHRDataSource = new YAHOO.util.DataSource("{/literal}{devblocks_url}ajax.php?c=reports&a=action&extid=report.tickets.open_tickets&extid_a=getOpenTicketsChart{/devblocks_url}{literal}");
