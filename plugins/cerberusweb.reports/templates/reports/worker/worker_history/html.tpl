...
<br>
	...
	{foreach from=$tickets_replied item=replied_tickets key=day}
			...
			<tr>
				...
				<td style="padding-right:20px;"><a href="javascript:;" onclick="genericAjaxPanel('c=contacts&a=showAddressPeek&email={$ticket->email|escape:'url'}&view_id=0',this,false,'500px',ajax.cbAddressPeek);">{$ticket->email}</a></td>
