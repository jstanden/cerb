...
<button type="button" id="btnSubmit" onclick="genericAjaxPost('frmRange', 'reportGroupReplies');drawChart(document.getElementById('start').value, document.getElementById('end').value);">Refresh</button>
