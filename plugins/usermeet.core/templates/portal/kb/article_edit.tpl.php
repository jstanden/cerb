	...
	<tbody>
		<tr>
			<td style="padding: 5px; vertical-align: top;">
				...
				{if !empty($article)}<button type="button" onclick="{literal}if(confirm('Are you sure you want to permanently delete this article?')){this.form.do_delete.value='1';this.form.submit();}{/literal}"><img src="{devblocks_url}c=resource&p=usermeet.core&f=images/delete2.gif{/devblocks_url}" alt="Delete" align="top"> {$translate->_('common.delete')|capitalize}</button>{/if}
				</form>
			</td>
		</tr>
	</tbody>
