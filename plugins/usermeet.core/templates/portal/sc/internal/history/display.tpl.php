...
<h2>Subject: {$ticket.t_subject|escape}</h2>
...
<button type="button" onclick="this.form.closed.value='0';this.form.submit();"><img src="{devblocks_url}c=resource&p=usermeet.core&f=images/folder_out.gif{/devblocks_url}" align="top"> Re-open</button>
{else}
<button type="button" onclick="this.form.closed.value='1';this.form.submit();"><img src="{devblocks_url}c=resource&p=usermeet.core&f=images/folder_ok.gif{/devblocks_url}" align="top"> Close</button>
{/if}
</form>
