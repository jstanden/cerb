...
<table cellpadding="0" cellspacing="0" border="0" width="100%">
	<tr>
		...
		<td style="padding-left:5px;">
			...
			<button type="button" name="btn_search" onclick="genericAjaxGet('replyToolbarOptions{$msg_id}_kbresults','c=kb.ajax&a=doTicketReplyKbSearch&msg_id={$msg_id}&q='+escape(this.form.q.value)+'&topic_id='+selectValue(this.form.topic_id));"><img src="{devblocks_url}c=resource&p=cerberusweb.core&f=images/data_find.gif{/devblocks_url}" align="top"> {$translate->_('common.search')|capitalize}</button>
			...
			<div id="replyToolbarOptions{$msg_id}_kbresults"></div>
			
			<button type="button" onclick="clearDiv('replyToolbarOptions{$msg_id}');"><img src="{devblocks_url}c=resource&p=cerberusweb.core&f=images/check.gif{/devblocks_url}" align="top"> {$translate->_('common.close')|capitalize}</button>
			</form>
