...
<table cellspacing="0" cellpadding="2" border="0" width="98%" style="margin-bottom:10px;">
	...
	<tr>
		...
		<td width="99%">
			<button type="button" class="chooser-abstract" data-field-name="parent_id" data-context="{CerberusContexts::CONTEXT_KB_CATEGORY}" data-single="true" data-query="" data-autocomplete="" data-autocomplete-if-empty="true" data-create="if-null" data-create-defaults=""><span class="cerb-icons cerb-icon-search"></span></button>
