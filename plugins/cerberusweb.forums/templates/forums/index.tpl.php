...
<h1>{$translate->_('forums.ui.forums')}:</h1>
	...
	<tr>
		<td style="padding-right:10px;" valign="top" width="1%" nowrap="nowrap">
			...
			<div class="block" style="width:200px;">
				<h2>{$translate->_('common.available')|capitalize}</h2>
				<a href="{devblocks_url}c=forums&a=overview&m=all{/devblocks_url}">-{$translate->_('common.all')|lower}-</a><br>
