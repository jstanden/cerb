{* begin time tracking *}
<div id="divTimeTrackingBox" style="display:{if isset($session.timetracking)}block{else}none{/if};position:fixed;width:150px;height:80px;top:20;right:20;background-color:rgb(50,50,50);color:rgb(255,255,255);opacity:.9;filter:alpha(opacity=90);z-index:2;vertical-align:middle;text-align:center;padding:5px;">
	{'timetracking.activity.tab'|devblocks_translate}<br>
	<div style="font-size:18pt;font-weight:bold;"><span id="divTimeTrackingCounter">--</span></div>
