...
<table cellpadding="2" cellspacing="0" border="0">
	...
	<tr>
		<td colspan="2">
			...
			{if !empty($fnr_topic)}<button type="button" onclick="if(confirm('Are you sure you want to delete this topic and all its resources?')){literal}{{/literal}this.form.do_delete.value=1;this.form.submit();{literal}}{/literal}"><img src="{devblocks_url}c=resource&p=cerberusweb.core&f=images/delete2.gif{/devblocks_url}" align="top"> {$translate->_('common.delete')|capitalize}</button>{/if}
		</td>
	</tr>
</table>
</div>