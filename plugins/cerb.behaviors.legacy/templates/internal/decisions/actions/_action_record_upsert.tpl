...
<div class="cerb-ui-form--field">
	<label class="cerb-ui-form--label">{'common.query'|devblocks_translate}<span class="cerb-ui-form--hint">e.g. name:"Exact Match"</span> {include file="devblocks:cerberusweb.core::help/docs_button.tpl" url="https://cerb.ai/docs/search/"}</label>
...
<div class="cerb-ui-form--field">
	<label class="cerb-ui-form--label">Also upsert records in simulator mode</label>
	<div>
