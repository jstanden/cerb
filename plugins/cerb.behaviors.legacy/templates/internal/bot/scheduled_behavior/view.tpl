	...
	<tbody style="cursor:pointer;">
		...
		{foreach from=$view->view_columns item=column name=columns}
			...
			<td data-column="{$column}">
				...
				<button type="button" class="peek cerb-peek-trigger" data-context="{CerberusContexts::CONTEXT_BEHAVIOR_SCHEDULED}" data-context-id="{$result.c_id}" data-profile-url="{devblocks_url}c=profiles&what=scheduled_behavior&id={$result.c_id}&name={$result.$column|devblocks_permalink}{/devblocks_url}"><span class="cerb-icons cerb-icon-new-window"></span></button>
			</td>
