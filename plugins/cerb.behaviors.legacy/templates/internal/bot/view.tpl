	...
	<tbody style="cursor:pointer;" class="{if $result.v_is_disabled}disabled{/if}">
		...
		{foreach from=$view->view_columns item=column name=columns}
			...
			<td data-column="{$column}">
				...
				<button type="button" class="peek cerb-peek-trigger" data-context="{$view_context}" data-context-id="{$result.v_id}" data-view-id="{$view->id}"><span class="cerb-icons cerb-icon-new-window"></span></button>
			</td>
