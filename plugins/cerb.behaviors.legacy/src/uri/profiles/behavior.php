...
class PageSection_ProfilesBehavior extends Extension_PageSection {
	...
	private function _profileAction_renderDecisionNodeMenu() {
		...
		$tpl->display('devblocks:cerb.behaviors.legacy::internal/decisions/menu.tpl');
	}
	...
	private function _profileAction_renderDecisionPopup() {
		...
		if($id) { // Edit node
			...
			if(!($trigger = DAO_TriggerEvent::get($trigger_id)))
				DevblocksPlatform::dieWithHttpError(null, 404);
		...
		switch($type) {
			case 'subroutine':
				$tpl->display('devblocks:cerb.behaviors.legacy::internal/decisions/editors/subroutine.tpl');
				break;
			...
			case 'switch':
				...
				$tpl->display('devblocks:cerb.behaviors.legacy::internal/decisions/editors/switch.tpl');
				break;
			...
			case 'loop':
				...
				$tpl->display('devblocks:cerb.behaviors.legacy::internal/decisions/editors/loop.tpl');
				break;
			...
			case 'outcome':
				...
				// Template
				$tpl->display('devblocks:cerb.behaviors.legacy::internal/decisions/editors/outcome.tpl');
				break;
			...
			case 'action':
				...
				// Template
				$tpl->display('devblocks:cerb.behaviors.legacy::internal/decisions/editors/action.tpl');
				break;
	...
	private function _profileAction_getTriggerVariableParams() {
		...
		$tpl->display('devblocks:cerb.behaviors.legacy::internal/decisions/editors/trigger_variable.tpl');
	}
	...
	private function _profileAction_renderSimulatorPopup() {
		...
		$tpl->display('devblocks:cerb.behaviors.legacy::internal/decisions/editors/simulate.tpl');
	}
	...
	private function _profileAction_runSimulator() {
		...
		$tpl->display('devblocks:cerb.behaviors.legacy::internal/decisions/simulator/results.tpl');
	}
	...
	private function _profileAction_renderExportPopup() {
		...
		$tpl->display('devblocks:cerb.behaviors.legacy::internal/decisions/editors/_export.tpl');
	}
	...
	private function _profileAction_renderDecisionReorderPopup() {
		...
		$tpl->display('devblocks:cerb.behaviors.legacy::internal/decisions/editors/_reorder.tpl');
	}
	...
	private function _profileAction_renderImportPopup() {
		...
		$tpl->display('devblocks:cerb.behaviors.legacy::internal/decisions/editors/_import.tpl');
	}
	...
	private function _profileAction_getParams() {
		...
		$tpl->display('devblocks:cerb.behaviors.legacy::events/_action_behavior_params.tpl');
	}
