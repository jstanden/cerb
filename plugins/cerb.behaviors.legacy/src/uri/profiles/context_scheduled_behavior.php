...
class PageSection_ProfilesContextScheduledBehavior extends Extension_PageSection {
	...
	private function _profileAction_renderContextScheduledBehavior() {
		...
		$tpl->assign('scheduled_behavior', $scheduled_behavior);
		
		$tpl->display('devblocks:cerb.behaviors.legacy::internal/macros/behavior/scheduled_behavior_profile.tpl');
	}
	...
	private function _profileAction_getBulkParams() {
		...
		$tpl->display('devblocks:cerb.behaviors.legacy::internal/decisions/assistant/behavior_variables_entry.tpl');
	}
}