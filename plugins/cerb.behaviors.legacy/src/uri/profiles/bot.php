...
class PageSection_ProfilesBot extends Extension_PageSection {
	 ...
	 * @deprecated
	 */
	public function startBotInteractionAsFormBehavior(Model_TriggerEvent $interaction_behavior) {
		...
		if(!($bot = $interaction_behavior->getBot())) {
		...
		if('inline' == $interaction_style) {
			$tpl->display('devblocks:cerb.behaviors.legacy::console/form/panel.tpl');
		} else {
			$tpl->display('devblocks:cerb.behaviors.legacy::console/form/popup.tpl');
		}
	}
	 ...
	 * @deprecated
	 */
	public function startBotInteractionAsConvoBehavior(Model_TriggerEvent $interaction_behavior) {
		$active_worker = CerberusApplication::getActiveWorker();
		...
		if(!($event = $interaction_behavior->getEvent()))
			DevblocksPlatform::dieWithHttpError(null, 404);
		...
		$tpl->display('devblocks:cerb.behaviors.legacy::console/window.tpl');
	}
		...
		foreach($actions as $params) {
			switch(@$params['_action']) {
				...
				default:
					...
					$tpl->display('devblocks:cerb.behaviors.legacy::console/form/continue.tpl');
					break;
			}
		}
	...
	private function _consoleSendMessageAsConvoBehavior(Model_BotSession $bot_session, Model_TriggerEvent $behavior) {
		...
		if(!($event = Extension_DevblocksEvent::get($event_model->id, true)))
			DevblocksPlatform::dieWithHttpError(null, 404);
		...
		if($resume_path) {
			...
			if(!($result = $behavior->resumeDecisionTree($dict, false, $event, $resume_path)))
				DevblocksPlatform::dieWithHttpError(null, 404);
			
		} else {
			if(!($result = $behavior->runDecisionTree($dict, false, $event)))
				DevblocksPlatform::dieWithHttpError(null, 404);
		}
		...
		if($result['exit_state'] == 'SUSPEND') {
			...
			if(is_array($caller)) {
				...
				$tpl->display('devblocks:cerb.behaviors.legacy::console/prompt_wait.tpl');
			}
		}
		...
		foreach($actions as $params) {
			...
			switch(@$params['_action']) {
				...
				case 'emote':
					...
					$tpl->display('devblocks:cerb.behaviors.legacy::console/emote.tpl');
					break;
				...
				case 'prompt.buttons':
					...
					$tpl->assign('delay_ms', 0);
					$tpl->display('devblocks:cerb.behaviors.legacy::console/prompt_buttons.tpl');
					break;
				...
				case 'prompt.chooser':
					...
					$tpl->assign('autocomplete', $autocomplete);
					$tpl->assign('delay_ms', 0);
					$tpl->display('devblocks:cerb.behaviors.legacy::console/prompt_chooser.tpl');
					break;
				...
				case 'prompt.date':
					...
					$tpl->assign('delay_ms', 0);
					$tpl->assign('placeholder', $placeholder);
					$tpl->display('devblocks:cerb.behaviors.legacy::console/prompt_date.tpl');
					break;
				
				case 'prompt.file':
					$tpl->assign('delay_ms', 0);
					$tpl->display('devblocks:cerb.behaviors.legacy::console/prompt_file.tpl');
					break;
				...
				case 'prompt.images':
					...
					$tpl->assign('delay_ms', 0);
					$tpl->display('devblocks:cerb.behaviors.legacy::console/prompt_images.tpl');
					break;
				...
				case 'prompt.text':
					...
					$tpl->assign('default', $default);
					$tpl->assign('mode', $mode);
					$tpl->display('devblocks:cerb.behaviors.legacy::console/prompt_text.tpl');
					break;
				...
				case 'message.send':
					...
					$tpl->display('devblocks:cerb.behaviors.legacy::console/message.tpl');
					break;
				...
				case 'script.send':
					...
					$tpl->assign('delay_ms', 0);
					$tpl->display('devblocks:cerb.behaviors.legacy::console/script.tpl');
					break;
				
				case 'window.close':
					$tpl->assign('delay_ms', 0);
					$tpl->display('devblocks:cerb.behaviors.legacy::console/window_close.tpl');
					break;
				...
				case 'worklist.open':
					...
					$tpl->display('devblocks:cerb.behaviors.legacy::console/search_worklist.tpl');
					break;
			}
		}
