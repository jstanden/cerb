...
class BotAction_RecordCreate extends Extension_DevblocksEventAction {
	...
	function render(Extension_DevblocksEvent $event, Model_TriggerEvent $trigger, $params=[], $seq=null) {
		...
		$tpl->display('devblocks:cerb.behaviors.legacy::internal/decisions/actions/_action_record_create.tpl');
	}
...
class BotAction_RecordUpdate extends Extension_DevblocksEventAction {
	...
	function render(Extension_DevblocksEvent $event, Model_TriggerEvent $trigger, $params=[], $seq=null) {
		...
		$tpl->assign('params', $params);
		$tpl->display('devblocks:cerb.behaviors.legacy::internal/decisions/actions/_action_record_update.tpl');
	}
...
class BotAction_RecordUpsert extends Extension_DevblocksEventAction {
	...
	function render(Extension_DevblocksEvent $event, Model_TriggerEvent $trigger, $params=[], $seq=null) {
		...
		$tpl->assign('params', $params);
		$tpl->display('devblocks:cerb.behaviors.legacy::internal/decisions/actions/_action_record_upsert.tpl');
	}
...
class BotAction_RecordDelete extends Extension_DevblocksEventAction {
	...
	function render(Extension_DevblocksEvent $event, Model_TriggerEvent $trigger, $params=[], $seq=null) {
		...
		$tpl->display('devblocks:cerb.behaviors.legacy::internal/decisions/actions/_action_record_delete.tpl');
	}
...
class BotAction_RecordRetrieve extends Extension_DevblocksEventAction {
	...
	function render(Extension_DevblocksEvent $event, Model_TriggerEvent $trigger, $params=[], $seq=null) {
		...
		$tpl->display('devblocks:cerb.behaviors.legacy::internal/decisions/actions/_action_record_retrieve.tpl');
	}
...
class BotAction_RecordSearch extends Extension_DevblocksEventAction {
	...
	function render(Extension_DevblocksEvent $event, Model_TriggerEvent $trigger, $params=[], $seq=null) {
		...
		$tpl->display('devblocks:cerb.behaviors.legacy::internal/decisions/actions/_action_record_search.tpl');
	}
