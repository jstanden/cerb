...
abstract class AbstractEvent_AjaxHttpRequest extends Extension_DevblocksEvent {
	...
	function renderConditionExtension($token, $as_token, $trigger, $params=[], $seq=null) {
		...
		switch($as_token) {
			case 'http_header':
				$tpl->display('devblocks:cerb.behaviors.legacy::events/ajax/condition_http_header.tpl');
				break;
				
			case 'http_param':
				$tpl->display('devblocks:cerb.behaviors.legacy::events/ajax/condition_http_param.tpl');
				break;
	...
	function renderActionExtension($token, $trigger, $params=[], $seq=null) {
		...
		switch($token) {
			case 'set_http_header':
				$tpl->display('devblocks:cerb.behaviors.legacy::events/ajax/action_set_http_header.tpl');
				break;
				
			case 'set_http_body':
				$tpl->display('devblocks:cerb.behaviors.legacy::events/ajax/action_set_http_body.tpl');
				break;
				
			case 'set_http_status':
				$tpl->display('devblocks:cerb.behaviors.legacy::events/ajax/action_set_http_status.tpl');
				break;
