	...
	function renderConditionExtension($token, $as_token, $trigger, $params=array(), $seq=null) {
		...
		switch($as_token) {
			...
			case 'attachment_mimetype':
				$tpl->display('devblocks:cerb.behaviors.legacy::internal/decisions/conditions/_string.tpl');
				break;
			...
			case 'header':
				...
				break;
			case 'recipients':
				$tpl->display('devblocks:cerb.behaviors.legacy::events/mail_received_by_app/condition_recipients.tpl');
				break;
		}
	...
	function renderActionExtension($token, $trigger, $params=array(), $seq=null) {
		...
		switch($token) {
			...
			case 'prepend_to_content':
				$tpl->display('devblocks:cerb.behaviors.legacy::events/mail_before_sent_by_group/action_add_content.tpl');
				break;
				
			case 'replace_content':
				$tpl->assign('is_sent', false);
				$tpl->display('devblocks:cerb.behaviors.legacy::events/mail_before_sent_by_group/action_replace_content.tpl');
				break;
			...
			case 'redirect_email':
				$tpl->display('devblocks:cerb.behaviors.legacy::events/mail_received_by_app/action_redirect_email.tpl');
				break;
			
			case 'remove_attachments':
				$tpl->display('devblocks:cerb.behaviors.legacy::events/mail_received_by_app/action_remove_attachments.tpl');
				break;
			
			case 'send_email_sender':
				//$tpl->assign('workers', DAO_Worker::getAll());
				$tpl->display('devblocks:cerb.behaviors.legacy::events/mail_received_by_app/action_send_email_sender.tpl');
				break;
				
			case 'set_header':
				$tpl->display('devblocks:cerb.behaviors.legacy::events/model/mail/action_set_header.tpl');
				break;
