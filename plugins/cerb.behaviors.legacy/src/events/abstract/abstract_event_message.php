	...
	function renderConditionExtension($token, $as_token, $trigger, $params=array(), $seq=null) {
		...
		switch($as_token) {
			case 'ticket_spam_score':
				$tpl->display('devblocks:cerb.behaviors.legacy::events/mail_received_by_group/condition_spam_score.tpl');
				break;
			case 'ticket_spam_training':
				$tpl->display('devblocks:cerb.behaviors.legacy::events/mail_received_by_group/condition_spam_training.tpl');
				break;
			case 'ticket_status':
				$tpl->display('devblocks:cerb.behaviors.legacy::events/mail_received_by_group/condition_status.tpl');
				break;
			case 'group_id':
				$groups = DAO_Group::getAll();
				$tpl->assign('groups', $groups);
				
				$tpl->display('devblocks:cerb.behaviors.legacy::events/model/ticket/condition_group.tpl');
				break;
			case 'group_and_bucket':
				...
				$tpl->display('devblocks:cerb.behaviors.legacy::events/model/ticket/condition_group_and_bucket.tpl');
				break;
			...
			case 'ticket_latest_message_headers':
				$tpl->display('devblocks:cerb.behaviors.legacy::events/mail_received_by_group/condition_header.tpl');
				break;
		}
	...
	function renderActionExtension($token, $trigger, $params=array(), $seq=null) {
		...
		switch($token) {
			...
			case 'send_email_recipients':
				...
				$tpl->display('devblocks:cerb.behaviors.legacy::events/mail_received_by_owner/action_send_email_recipients.tpl');
				break;
			...
			case 'move_to':
				...
				$tpl->display('devblocks:cerb.behaviors.legacy::events/model/ticket/action_move_to.tpl');
				break;
				
			case 'set_spam_training':
				$tpl->display('devblocks:cerb.behaviors.legacy::events/mail_received_by_group/action_set_spam_training.tpl');
				break;
				
			case 'set_status':
				$tpl->display('devblocks:cerb.behaviors.legacy::events/mail_received_by_group/action_set_status.tpl');
				break;
				
			case 'set_subject':
				$tpl->display('devblocks:cerb.behaviors.legacy::internal/decisions/actions/_set_string.tpl');
				break;
		...
		switch($token) {
			...
			case 'move_to':
				...
				$out = sprintf(">>> Moving to:\n%s: %s\n",
					$groups[$group_id]->name ?? '(no group)',
					$buckets[$bucket_id]->name ?? '(no bucket)'
				);
	...
	function runActionExtension($token, $trigger, $params, DevblocksDictionaryDelegate $dict) {
		...
		switch($token) {
			...
			case 'send_email_recipients':
				...
				if(array_key_exists('is_autoreply', $params) && !empty($params['is_autoreply']))
