	...
	function renderActionExtension($token, $trigger, $params=[], $seq=null) {
		...
		switch($token) {
			case 'interaction_end':
				$tpl->display('devblocks:cerb.behaviors.legacy::events/form_interaction/_common/action_end.tpl');
				break;
				
			case 'prompt_captcha':
				$tpl->display('devblocks:cerb.behaviors.legacy::events/form_interaction/_common/prompts/action_prompt_captcha.tpl');
				break;
				
			case 'prompt_checkboxes':
				$tpl->display('devblocks:cerb.behaviors.legacy::events/form_interaction/_common/prompts/action_prompt_checkboxes.tpl');
				break;
			...
			case 'prompt_chooser':
				...
				$tpl->display('devblocks:cerb.behaviors.legacy::events/form_interaction/_common/prompts/action_prompt_chooser.tpl');
				break;
				
			case 'prompt_compose':
				$tpl->display('devblocks:cerb.behaviors.legacy::events/form_interaction/_common/prompts/action_prompt_compose.tpl');
				break;
				
			case 'prompt_files':
				$tpl->display('devblocks:cerb.behaviors.legacy::events/form_interaction/_common/prompts/action_prompt_files.tpl');
				break;
				
			case 'prompt_radios':
				$tpl->display('devblocks:cerb.behaviors.legacy::events/form_interaction/_common/prompts/action_prompt_radios.tpl');
				break;
			
			case 'prompt_reply':
				$tpl->display('devblocks:cerb.behaviors.legacy::events/form_interaction/_common/prompts/action_prompt_reply.tpl');
				break;
			
			case 'prompt_sheet':
				$tpl->display('devblocks:cerb.behaviors.legacy::events/form_interaction/_common/prompts/action_prompt_sheet.tpl');
				break;
				
			case 'prompt_text':
				$tpl->display('devblocks:cerb.behaviors.legacy::events/form_interaction/_common/prompts/action_prompt_text.tpl');
				break;
				
			case 'prompt_submit':
				$tpl->display('devblocks:cerb.behaviors.legacy::events/form_interaction/_common/action_prompt_submit.tpl');
				break;
			
			case 'respond_text':
				$tpl->display('devblocks:cerb.behaviors.legacy::events/form_interaction/_common/responses/action_respond_text.tpl');
				break;
			...
			case 'respond_sheet':
				...
				$tpl->assign('params', $params);
				$tpl->display('devblocks:cerb.behaviors.legacy::events/form_interaction/_common/responses/action_respond_sheet.tpl');
				break;
		}
