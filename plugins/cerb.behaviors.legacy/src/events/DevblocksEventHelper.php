...
class DevblocksEventHelper {
	...
	public static function renderSimulatorTarget($context, $context_id, $trigger, $event_model) {
		...
		$tpl->display('devblocks:cerb.behaviors.legacy::internal/decisions/simulator/target.tpl');
	}
	...
	static function renderActionSetCustomField(Model_CustomField $custom_field, $trigger) {
		...
		switch($custom_field->type) {
			...
			case Model_CustomField::TYPE_NUMBER:
				$tpl->display('devblocks:cerb.behaviors.legacy::internal/decisions/actions/_set_number.tpl');
				break;
			...
			case Model_CustomField::TYPE_CHECKBOX:
				$tpl->display('devblocks:cerb.behaviors.legacy::internal/decisions/actions/_set_bool.tpl');
				break;
			...
			case Model_CustomField::TYPE_DATE:
				...
				$tpl->display('devblocks:cerb.behaviors.legacy::internal/decisions/actions/_set_date.tpl');
				break;
				
			case Model_CustomField::TYPE_DROPDOWN:
				$tpl->assign('options', @$custom_field->params['options']);
				$tpl->display('devblocks:cerb.behaviors.legacy::internal/decisions/actions/_set_dropdown.tpl');
				$tpl->clearAssign('options');
				break;
				
			case Model_CustomField::TYPE_LIST:
				$tpl->display('devblocks:cerb.behaviors.legacy::internal/decisions/actions/_set_list.tpl');
				break;
				
			case Model_CustomField::TYPE_MULTI_CHECKBOX:
				$tpl->assign('options', @$custom_field->params['options']);
				$tpl->display('devblocks:cerb.behaviors.legacy::internal/decisions/actions/_set_multi_checkbox.tpl');
				$tpl->clearAssign('options');
				break;
			...
			case Model_CustomField::TYPE_WORKER:
				...
				$tpl->display('devblocks:cerb.behaviors.legacy::internal/decisions/actions/_set_worker.tpl');
				break;
	...
	static function renderActionSetVariablePicklist($token, $trigger, $params) {
		...
		$tpl->display('devblocks:cerb.behaviors.legacy::internal/decisions/actions/_set_var_picklist.tpl');
	}
	...
	static function renderActionSetVariableWorker($token, $trigger, $params) {
		...
		// Template
		$tpl->display('devblocks:cerb.behaviors.legacy::internal/decisions/actions/_set_var_worker.tpl');
	}
	...
	static function renderActionSetListVariable($token, $trigger, $params, $context) {
		...
		$tpl->display('devblocks:cerb.behaviors.legacy::internal/decisions/actions/_set_var_list.tpl');
	}
	...
	static function renderActionSetListAbstractVariable($token, $trigger, $params) {
		...
		$tpl->display('devblocks:cerb.behaviors.legacy::internal/decisions/actions/_set_var_list_abstract.tpl');
	}
	...
	static function renderActionSetLinks($trigger) {
		...
		$tpl->display('devblocks:cerb.behaviors.legacy::events/action_set_links.tpl');
	}
	...
	static function renderActionSetPlaceholderUsingSnippet($trigger, $params) { /* @var $trigger Model_TriggerEvent */
		...
		$tpl->display('devblocks:cerb.behaviors.legacy::events/action_set_placeholder_using_snippet.tpl');
	}
	...
	static function renderActionGetWorklistMetric($trigger) { /* @var $trigger Model_TriggerEvent */
		...
		$tpl->display('devblocks:cerb.behaviors.legacy::events/action_get_worklist_metric.tpl');
	}
	...
	static function renderActionGetKey($trigger) { /* @var $trigger Model_TriggerEvent */
		...
		$tpl->display('devblocks:cerb.behaviors.legacy::events/action_get_key.tpl');
	}
	...
	static function renderActionSetKey($trigger) { /* @var $trigger Model_TriggerEvent */
		...
		$tpl->display('devblocks:cerb.behaviors.legacy::events/action_set_key.tpl');
	}
	...
	static function renderActionGetLinks($trigger) { /* @var $trigger Model_TriggerEvent */
		...
		$tpl->display('devblocks:cerb.behaviors.legacy::events/action_get_links.tpl');
	}
	...
	static function renderActionRunBehavior($trigger) {
		...
		$tpl->display('devblocks:cerb.behaviors.legacy::events/action_run_behavior.tpl');
	}
	...
	static function renderActionScheduleBehavior($trigger) {
		...
		$tpl->display('devblocks:cerb.behaviors.legacy::events/action_schedule_behavior.tpl');
	}
	...
	static function renderActionUnscheduleBehavior($trigger) {
		...
		$tpl->display('devblocks:cerb.behaviors.legacy::events/action_unschedule_behavior.tpl');
	}
	...
	static function renderActionCreateCalendarEvent($trigger) {
		...
		// Template
		$tpl->display('devblocks:cerb.behaviors.legacy::internal/decisions/actions/_create_calendar_event.tpl');
	}
	...
	static function renderActionCreateComment($trigger) {
		...
		$tpl->display('devblocks:cerb.behaviors.legacy::internal/decisions/actions/_create_comment.tpl');
	}
	...
	static function renderActionScheduleTicketReply() {
		$tpl = DevblocksPlatform::services()->template();
		$tpl->display('devblocks:cerb.behaviors.legacy::events/model/ticket/action_schedule_email_recipients.tpl');
	}
	...
	static function renderActionSetTicketOrg($trigger) {
		...
		$tpl->display('devblocks:cerb.behaviors.legacy::internal/decisions/actions/_set_org.tpl');
	}
	...
	static function renderActionAddRecipients($trigger) {
		$tpl = DevblocksPlatform::services()->template();
		$tpl->display('devblocks:cerb.behaviors.legacy::internal/decisions/actions/_picker_email_addresses.tpl');
	}
	...
	static function renderActionAddWatchers($trigger) {
		...
		$tpl->display('devblocks:cerb.behaviors.legacy::internal/decisions/actions/_add_watchers.tpl');
	}
	...
	static function renderActionCreateNotification($trigger) {
		...
		$tpl->display('devblocks:cerb.behaviors.legacy::internal/decisions/actions/_create_notification.tpl');
	}
	...
	static function renderActionCreateMessageStickyNote($trigger) {
		...
		$tpl->display('devblocks:cerb.behaviors.legacy::internal/decisions/actions/_create_message_sticky_note.tpl');
	}
	...
	static function renderActionCreateTask($trigger) {
		...
		// Template
		$tpl->display('devblocks:cerb.behaviors.legacy::internal/decisions/actions/_create_task.tpl');
	}
	...
	static function renderActionCreateTicket($trigger) {
		...
		// Template
		$tpl->display('devblocks:cerb.behaviors.legacy::internal/decisions/actions/_create_ticket.tpl');
	}
	...
	static function renderActionSendEmail($trigger, $placeholders=[]) {
		...
		$tpl->display('devblocks:cerb.behaviors.legacy::internal/decisions/actions/_send_email.tpl');
	}
	...
	static function renderActionRelayEmail($filter_to_worker_ids=[], $show=array('owner','watchers','workers'), $content_token='content') {
		...
		$tpl->display('devblocks:cerb.behaviors.legacy::internal/decisions/actions/_relay_email.tpl');
	}
