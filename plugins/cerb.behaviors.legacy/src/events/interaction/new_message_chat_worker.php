	...
	function renderActionExtension($token, $trigger, $params=[], $seq=null) {
		...
		switch($token) {
			...
			case 'prompt_chooser':
				...
				$tpl->display('devblocks:cerb.behaviors.legacy::events/pm/action_prompt_chooser.tpl');
				break;
			...
			case 'prompt_file':
				$tpl->display('devblocks:cerb.behaviors.legacy::events/pm/action_prompt_file.tpl');
				break;
			...
			case 'switch_behavior':
				$tpl->display('devblocks:cerb.behaviors.legacy::events/pm/action_switch_behavior.tpl');
				break;
			...
			case 'worklist_open':
				...
				$tpl->display('devblocks:cerb.behaviors.legacy::events/pm/action_worklist_open.tpl');
				break;
		}
