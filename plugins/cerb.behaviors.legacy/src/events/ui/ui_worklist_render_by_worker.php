	...
	function renderConditionExtension($token, $as_token, $trigger, $params=array(), $seq=null) {
		...
		switch($as_token) {
			case 'context':
				...
				$tpl->display('devblocks:cerb.behaviors.legacy::internal/decisions/conditions/_list.tpl');
				break;
		}
	...
	function renderActionExtension($token, $trigger, $params=array(), $seq=null) {
		...
		switch($token) {
			case 'exec_jquery':
				...
				$tpl->display('devblocks:cerb.behaviors.legacy::events/ui/reply/action_exec_jquery.tpl');
				break;
		}
