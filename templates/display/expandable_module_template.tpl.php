  ...
  <tbody>
    <tr>
      <td width="0%" nowrap="nowrap" valign="top">
      	<a href="javascript:;" onclick="toggleDiv('{$display_module->manifest->id}_body');"><img src="{$smarty.const.DEVBLOCKS_WEBPATH}images/icon_collapse.gif" width="16" height="16" border="0" align="absmiddle"></a> 
      	<img src="{$smarty.const.DEVBLOCKS_WEBPATH}{$display_module->manifest->params.icon}" width="16" height="16" align="absmiddle">
      </td>
