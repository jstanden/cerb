...
<table cellpadding="0" cellspacing="0" border="0" width="100%" class="headerMenu">
	<tr>
		{foreach from=$pages item=m}
			...
			{/if}
		{/foreach}
		<td width="100%"><img src="{devblocks_url}images/spacer.gif{/devblocks_url}" height="22" width="1"></td>
	</tr>
</table>
<table cellpadding="0" cellspacing="0" border="0" width="100%">
	<tr><td class="headerUnderline"><img src="{devblocks_url}images/spacer.gif{/devblocks_url}" height="5" width="1"></td></tr>
</table>
<img src="{devblocks_url}images/spacer.gif{/devblocks_url}" height="5" width="1"><br>