...
class Memcached  {
	 ...
	 * @param int $flags Flags to control the returned result. When Memcached::GET_EXTENDED
	 ...
	 * @param callable $cache_cb Read-through caching callback or null
	 * @param int $flags Flags to control the returned result. When value of Memcached::GET_EXTENDED
	 ...
	 * @param int $weight The weight of the server relative to the total weight of all the
