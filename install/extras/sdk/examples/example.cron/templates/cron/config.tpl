...
&lt;plugin&gt;
	...
	&lt;description&gt;This example plugin adds an example cron to the scheduler page, and logs output when the task is run&lt;/description&gt;
...
<ul>
	...
	<li>
		<strong>&lt;id&gt;</strong> must be unique across all Cerb4 plugins. This is a dot-delimited namespace string. The name is entirely up to you, but the namespace should follow the name of your plugin, and the ID itself should have a hierarchy. If your plugin is named xyzcompany.myplugin then your extension IDs should follow the convention xyzcompany.myplugin.point.name where point.name represents the extension point and a unique identifier for each particular extension.
	</li>
	<li>
