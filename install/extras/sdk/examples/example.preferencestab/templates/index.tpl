...
<br>
<h2>Overview</h2>
The <strong>cerberusweb.preferences.tab</strong> extension point allows you to create new tabs on the My Account page.
...
&lt;plugin&gt;
	...
	&lt;description&gt;This example plugin adds an example tab to the preferences page (helpdesk setup)&lt;/description&gt;
