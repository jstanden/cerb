...
<br>
<h2>Overview</h2>
The <strong>cerberusweb.activity.tab</strong> extension point allows you to create new tabs on the Activity page. This space is available for use by any plugin that wants to display content from worker activity; rather than polluting the main navigation with cerberusweb.page links. This organization strategy is repeated in many places: <em>Config, Preferences, Activity, Research, Display Ticket, and Address Book.</em>

Several official extensions add their own tab to the Activity page:
<ul>
	<li>Feedback Capture</li>
	<li>Forum Explorer</li>
