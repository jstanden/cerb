...
<br>
<h2>Overview</h2>
The <strong>cerberusweb.org.tab</strong> extension point allows you to create new tabs on the Organization display page. This will allow you to add extra tabs to display whatever data you wish to display on an Organization-specific level.
