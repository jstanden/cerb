<h1>This is the example config tab</h1>
<br>
<h2>Overview</h2>
The <strong>cerberusweb.config.tab</strong> extension point allows you to create new tabs on the Config page. This space is available for use by any plugin that wants to display content under config; rather than polluting the main navigation with cerberusweb.page links. This organization strategy is repeated in many places: <em>Config, Preferences, Activity, Research, Display Ticket, and Address Book.</em>

Several official extensions add their own tab to the Config page:
<ul>
	<li>Translations</li>
	<li>Watchers</li>
	<li>Simulator</li>
