...
<fieldset>
	...
	<table cellspacing="0" cellpadding="2" border="0" width="98%">
		...
		<tr>
			<td width="1%" valign="top" nowrap="nowrap">{'common.owners'|devblocks_translate|capitalize}:</td>
...
<button type="button" onclick="genericAjaxPopupPostCloseReloadView('peek','frmExampleObject','{$view_id}',false,'example_object_save');"><span class="cerb-sprite sprite-check"></span> {$translate->_('common.save_changes')|capitalize}</button>
{if $model->id}<button type="button" onclick="if(confirm('Permanently delete this example object?')) { this.form.do_delete.value='1';genericAjaxPopupPostCloseReloadView('peek','frmExampleObject','{$view_id}'); } "><span class="cerb-sprite sprite-forbidden"></span> {$translate->_('common.delete')|capitalize}</button>{/if}
</form>
