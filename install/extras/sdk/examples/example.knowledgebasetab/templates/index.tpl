...
<br>
<h2>Overview</h2>
The <strong>cerberusweb.knowledgebase.tab</strong> extension point allows you to create new tabs on the Knowledgebase page. This space is available for use by any plugin that wants to display content under Knowledgebase; rather than polluting the main navigation with cerberusweb.page links. This organization strategy is repeated in many places: <em>Config, Preferences, Activity, Research, Display Ticket, and Address Book.</em>
...
&lt;plugin&gt;
	...
	&lt;extensions&gt;
		&lt;extension point="cerberusweb.knowledgebase.tab"&gt;
			...
			&lt;name&gt;Example Knowledgebase Tab&lt;/name&gt;
			&lt;class&gt;
