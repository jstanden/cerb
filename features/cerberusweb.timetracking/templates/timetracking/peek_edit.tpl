...
<div class="buttons">
	...
	<button type="button" class="resume"><span class="cerb-icons cerb-icon-play"></span> {'timetracking.ui.entry_panel.resume'|devblocks_translate}</button>
...
$(function() {
	...
	$popup.one('popup_open',function() {
		...
		$popup.find('button.delete-cancel').click(
				{
					mode: 'delete',
					after: function(evt) {
						if(evt.hasOwnProperty('id') && timeTrackingTimer.id == evt.id)
				...
				Devblocks.callbackPeekEditDeleteCancel
		);
