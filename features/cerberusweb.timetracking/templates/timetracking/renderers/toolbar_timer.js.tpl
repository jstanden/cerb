...
var $new_button = $('<button type="button" title="{'timetracking.ui.button.track'|devblocks_translate|capitalize}">&nbsp;<span class="cerb-sprite sprite-stopwatch"></span>&nbsp;</button>');
