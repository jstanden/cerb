{$view_context = CerberusContexts::CONTEXT_TIMETRACKING_ACTIVITY}
...
<input type="hidden" name="module" value="timetracking_activity">
	...
	<tbody style="cursor:pointer;">
		...
		{foreach from=$view->view_columns item=column name=columns}
			...
			<td>
				...
				<a href="{devblocks_url}c=profiles&type=timetracking_activity&id={$result.t_id}-{$result.t_name|devblocks_permalink}{/devblocks_url}" class="subject">{$result.t_name}</a>
