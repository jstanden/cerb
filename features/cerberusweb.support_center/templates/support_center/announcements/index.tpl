...
<fieldset>
	...
	{if !empty($feed.url)}
	<div>
		<img src="{devblocks_url}c=resource&p=cerberusweb.support_center&f=images/feed-icon-16x16.gif{/devblocks_url}" alt="RSS" align="top" border="0"> <a href="{$feed.url|escape}" target="_blank">Subscribe</a>
		<br>
		<br>
	</div>
	{/if}
