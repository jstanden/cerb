	...
	<tbody style="cursor:pointer;">
		<tr class="{$tableRowClass}">
			<td data-column="label" colspan="{$smarty.foreach.headers.total}">
				...
				<a href="javascript:;" onclick="genericAjaxPopup('peek','c=internal&a=invoke&module=portals&action=renderTemplatePeek&view_id={$view->id}&id={$result.d_id}',null,false,'80%');" class="subject">{$result.d_path}</a>
			</td>
		</tr>
		<tr class="{$tableRowClass}">
