...
{if !empty($attachments)}
	<fieldset>
		...
		<ul style="margin-top:0px;">
			...
			<li>
				<a href="{devblocks_url}c=ajax&a=downloadFile&id={$attachment->storage_sha1hash}&name={$attachment->name|escape:'url'}{/devblocks_url}" target="_blank">{$attachment->name}</a>
