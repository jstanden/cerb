<div id="widget{$widget->id}Config" style="margin-top:10px;">
	<fieldset class="peek">
		...
		<div style="margin-left:10px;">
			<input type="text" name="params[project_board_id]" value="{$widget->params.project_board_id}" class="placeholders" style="width:95%;padding:5px;border-radius:5px;" autocomplete="off" spellcheck="off">
		</div>
	</fieldset>
</div>
