...
We share 100% of our source code on GitHub. Cerb is free to self-host, with unlimited workers and no subscription required. This allows you to maintain an archive of your historical data on the latest version in perpetuity at no ongoing cost. It's your data.
