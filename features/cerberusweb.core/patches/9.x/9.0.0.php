...
$checksum = $db->GetOne("SELECT sha1(extension_params_json) from profile_widget WHERE name = 'Status' AND profile_tab_id IN (SELECT id FROM profile_tab WHERE context = 'cerberusweb.contexts.ticket' AND name = 'Overview')");
