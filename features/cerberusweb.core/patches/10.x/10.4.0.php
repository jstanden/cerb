...
if(($actions_widget_id = $db->GetOneMaster("SELECT id FROM profile_widget WHERE extension_id = 'cerb.profile.tab.widget.html' AND name = 'Actions' and sha1(extension_params_json) IN ('ac1657461860614113d3c4317c11b2cec732c1c7','07e921a65185833e408338a3c9dad4ed03df9b6a') AND profile_tab_id IN (SELECT id FROM profile_tab WHERE context = 'cerberusweb.contexts.ticket' AND name = 'Overview')"))) {
