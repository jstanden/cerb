...
// ===========================================================================
// Update the ticket status and owner widgets to new endpoints
...
$sql = sprintf("UPDATE profile_widget SET extension_id = 'cerb.profile.tab.widget.sheet', extension_params_json = %s WHERE extension_id = 'cerb.profile.tab.widget.html' AND name = 'Owner' AND profile_tab_id IN (SELECT id FROM profile_tab WHERE context = 'cerberusweb.contexts.ticket' AND name = 'Overview')",
	$db->qstr($json)
);
$db->ExecuteMaster($sql);
