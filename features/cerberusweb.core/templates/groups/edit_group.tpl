<div id="groupTabs">
	<ul>
		...
		<li><a href="{devblocks_url}ajax.php?c=internal&a=showAssistantTab&point=cerberusweb.page.group&point=cerberusweb.groups.tab&context={CerberusContexts::CONTEXT_GROUP}&context_id={$team->id}{/devblocks_url}">Virtual Assistant</a></li>
