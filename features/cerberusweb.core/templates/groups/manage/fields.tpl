...
<fieldset>
	...
	<button type="button" onclick="this.form.allow_delete.value='1';this.form.submit();"><span class="cerb-sprite2 sprite-cross-circle"></span> {'delete checked'|capitalize}</button>
</fieldset>
