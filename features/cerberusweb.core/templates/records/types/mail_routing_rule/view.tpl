{$view_context = CerberusContexts::CONTEXT_MAIL_ROUTING_RULE}
        ...
        {foreach from=$data item=result key=idx name=results}
            ...
            <tr class="{$tableRowClass}">
                ...
                {foreach from=$view->view_columns item=column name=columns}
                    ...
                    {elseif in_array($column, ['m_is_disabled'])}
                    ...
                    {elseif $column == "m_name"}
                        <td>
                            ...
                            <a href="{devblocks_url}c=profiles&type=mail_routing_rule&id={$result.m_id}-{$result.m_name|devblocks_permalink}{/devblocks_url}" class="subject">{$result.m_name}</a>
...
<script nonce="{DevblocksPlatform::getRequestNonce()}" type="text/javascript">
    $(function() {
        ...
        {include file="devblocks:cerberusweb.core::internal/views/sparkline_loader.tpl" spark_module='mail_routing_rule' spark_action='viewSparklinesJson' spark_view_id=$view->id spark_tooltip_labels=true}
        {/if}
