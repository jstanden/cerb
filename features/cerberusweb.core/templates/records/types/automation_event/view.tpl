{$view_context = CerberusContexts::CONTEXT_AUTOMATION_EVENT}
                ...
                {foreach from=$view->view_columns item=column name=columns}
                    ...
                    {elseif $column == "a_name"}
                        <td>
                            ...
                            <a href="{devblocks_url}c=profiles&type=automation_event&id={$result.a_id}-{$result.a_name|devblocks_permalink}{/devblocks_url}" class="subject">{$result.a_name}</a>
