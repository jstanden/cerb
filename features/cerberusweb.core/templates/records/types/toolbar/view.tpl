{$view_context = CerberusContexts::CONTEXT_TOOLBAR}
                ...
                {foreach from=$view->view_columns item=column name=columns}
                    ...
                    {elseif $column == "t_name"}
                        <td>
                            ...
                            <a href="{devblocks_url}c=profiles&type=toolbar&id={$result.t_id}-{$result.t_name|devblocks_permalink}{/devblocks_url}" class="subject">{$result.t_name}</a>
