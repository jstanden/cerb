...
<button type="button" title="{'common.test'|devblocks_translate|capitalize}" class="cerb-code-editor-toolbar-button cerb-editor-button-event-tester"><span class="cerb-icons cerb-icon-lab"></span></button>
