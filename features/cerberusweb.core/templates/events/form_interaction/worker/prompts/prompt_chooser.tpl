...
<div class="cerb-form-builder-prompt cerb-form-builder-prompt-chooser" id="{$element_id}">
	...
	<button type="button" class="chooser-abstract" data-field-name="prompts[{$var}][]" data-context="{$record_type}" {if $selection == "single"}data-single="true"{/if} data-query="{$record_query}" data-query-required="{$record_query_required}" data-shortcuts="false"><span class="glyphicons glyphicons-search"></span></button>
