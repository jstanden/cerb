...
<label><input type="radio" name="{$namePrefix}[status]" value="completed" {if $params.status=='completed'}checked="checked"{/if}> {'status.completed'|devblocks_translate|capitalize}</label> 
