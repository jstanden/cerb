...
<fieldset id="{$fieldset_id}" style="margin-top:5px;">
	<b>Listen on these interaction points:</b> (one per line, <tt>*</tt> for wildcards)
	<br>
	<textarea name="event_params[listen_points]" rows="6" cols="45" style="height:8em;width:100%;">{$trigger->event_params.listen_points}</textarea>
	<div>
