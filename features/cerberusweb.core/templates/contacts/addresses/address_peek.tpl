...
{if $active_worker->hasPriv('core.addybook.addy.actions.update')}
	<button name="submit" type="button" onclick="if($('#formAddressPeek').validate().form()) { genericAjaxPopupPostCloseReloadView('peek','formAddressPeek', '{$view_id}'); } "><span class="cerb-sprite2 sprite-tick-circle-frame"></span> {$translate->_('common.save_changes')}</button>
{else}
