...
<tr>
	<td width="1%" nowrap="nowrap" valign="top" style="padding-right:5px;">
		...
		{if $active_worker->hasPriv('core.addybook.org.actions.update')}
			<button type="button" onclick="genericAjaxPopup('peek','c=contacts&a=showOrgPeek&id=0&view_id={$view->id}',null,false,'500');"><span class="cerb-sprite sprite-add"></span> {$translate->_('addy_book.org.add')|capitalize}</button>
		{/if}
		</form>
	</td>
