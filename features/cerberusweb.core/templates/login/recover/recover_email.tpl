...
<div class="cerb-login-card cerb-ui-panel cerb-ui-panel--filled">
	...
	<div class="cerb-ui-header">
		<div>
			<div class="cerb-ui-header--title-sm">Recover your account</div>
			<div class="cerb-ui-header--subtitle">Enter your email address and we'll send a recovery code.</div>
		</div>
	</div>
	...
	<div class="cerb-ui-form">
		<div class="cerb-ui-form--field">
			...
			<div class="cerb-ui-form--help">Only one recovery code will be sent within 30 minutes.</div>
		</div>
