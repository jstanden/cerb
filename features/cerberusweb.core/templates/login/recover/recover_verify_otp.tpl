...
<div class="cerb-login-card cerb-ui-panel cerb-ui-panel--filled">
	...
	<div class="cerb-ui-header">
		<div>
			<div class="cerb-ui-header--title-sm">Verify your identity</div>
			<div class="cerb-ui-header--subtitle">Your account has two-factor authentication enabled. Enter the security code from your device (e.g. Apple Keychain, 1Password, Google Authenticator) to finish recovering your account.</div>
		</div>
	</div>
