...
<div id="profileTicketTabs">
	<ul>
		...
		{$tabs[] = 'history'}
		<li data-alias="history"><a href="{devblocks_url}ajax.php?c=display&a=showContactHistory&point={$point}&ticket_id={$ticket->id}{/devblocks_url}">{'display.tab.history'|devblocks_translate}</a></li>
