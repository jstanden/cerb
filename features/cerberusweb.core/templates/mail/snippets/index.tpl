<form action="{devblocks_url}{/devblocks_url}" method="post" style="padding-bottom:5px;">
	...
	<select name="context">
		<option value="cerberusweb.snippets.plaintext">Plaintext</option>
		<option value="cerberusweb.snippets.ticket">Ticket</option>
		<option value="cerberusweb.snippets.worker">Worker</option>
	</select><!--
