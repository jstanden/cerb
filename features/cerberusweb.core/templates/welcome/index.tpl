...
<form>
	<button type="button" onclick="document.location.href='{devblocks_url}c=profiles&what=worker&who=me&tab=settings{/devblocks_url}';"><span class="glyphicons glyphicons-circle-ok" style="color:rgb(0,180,0);"></span> Let's set up your account!</button>
</form>