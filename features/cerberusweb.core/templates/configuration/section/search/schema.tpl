...
<fieldset>
	<legend>
		...
		(<a onclick="genericAjaxPopup('peek','c=config&a=invoke&module=search&action=showSearchSchemaPeek&ext_id={$schema->manifest->id}', null, false);">{'common.edit'|devblocks_translate|lower}</a>)
	</legend>
