<form style="margin:5px 0px;">
	<button type="button" onclick="genericAjaxPopup('peek','c=config&a=handleSectionAction&section=portal&action=showAddTemplatePeek&portal={$tool->code}&view_id={$view->id|escape:'url'}',null,false,'600');"><span class="cerb-sprite2 sprite-plus-circle-frame"></span> Add Custom Template</button>	
