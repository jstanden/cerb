...
{if $active_worker->is_superuser}
	<button type="button" onclick="genericAjaxPopupClose('peek');genericAjaxPost('formPortalTemplatePeek', 'view{$view_id}', '');"><span class="cerb-sprite2 sprite-tick-circle"></span> {$translate->_('common.save_changes')}</button>
	{if !$disabled}
