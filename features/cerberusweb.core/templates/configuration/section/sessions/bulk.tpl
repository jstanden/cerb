	...
	<table cellspacing="0" cellpadding="2" width="100%">
		<tr>
			...
			<td width="100%">
				<select name="deleted">
					<option value="">&nbsp;</option>
					<option value="1">{'status.deleted'|devblocks_translate}</option>
				</select>
				
				<button type="button" onclick="this.form.deleted.selectedIndex=1;">{'status.deleted'|devblocks_translate}</button>
			</td>
		</tr>
	</table>
</fieldset>
