				...
				<div style="margin:5px;">
					{if !empty($plugin)}
						{if $plugin->version < $result.p_latest_version}
							<div class="badge badge-lightgray" style="padding:3px;"><a href="javascript:;" onclick="genericAjaxPopup('peek','c=config&a=handleSectionAction&section=plugin_library&action=showDownloadPopup&plugin_id={$result.p_id}&view_id={$view->id}',this,true,'550');" style="color:rgb(0,150,0);text-decoration:none;font-weight:bold;">Installed; Upgrade to {DevblocksPlatform::intVersionToStr($result.p_latest_version)} &#x25be;</a></div>
						{else}
						...
						{* [TODO] Is there an upgrade? *}
						
						{*
						{if !$plugin->enabled}
							<div class="badge badge-lightgray" style="padding:3px;"><a href="javascript:;" style="color:rgb(120,0,0);font-weight:bold;text-decoration:none;">Disabled</a></div>
						{/if}
						*}
					...
					{else}
						...
						{else}
							<div class="badge badge-lightgray" style="padding:3px;"><a href="javascript:;" onclick="genericAjaxPopup('peek','c=config&a=handleSectionAction&section=plugin_library&action=showDownloadPopup&plugin_id={$result.p_id}&view_id={$view->id}',this,true,'550');" style="color:rgb(0,150,0);text-decoration:none;font-weight:bold;">Download and install &#x25be;</a></div>
						{/if}
						*}
						<div class="badge badge-lightgray" style="padding:3px;"><a href="javascript:;" onclick="genericAjaxPopup('peek','c=config&a=handleSectionAction&section=plugin_library&action=showDownloadPopup&plugin_id={$result.p_id}&view_id={$view->id}',this,true,'550');" style="color:rgb(0,150,0);text-decoration:none;font-weight:bold;">Download and install &#x25be;</a></div>
					{/if}
