<fieldset>
	<legend>
		...
		(<a onclick="genericAjaxPopup('peek','c=config&a=invoke&module=storage_content&action=showStorageSchemaPeek&ext_id={$schema->manifest->id}', null, false);">{'common.edit'|devblocks_translate|lower}</a>)
		{/if}
	</legend>
