...
<li>Advanced: open <a href="{devblocks_url full=true}c=cron{/devblocks_url}?loglevel=3" target="_blank" rel="noopener"><b>{devblocks_url full=true}c=cron{/devblocks_url}?loglevel=3</b></a> with wget/lynx in an external cron/scheduled task</li>
</ul>
