<fieldset>
	...
	<button type="button" onclick="toggleDiv('jobedit_{$extid}');"><span class="glyphicons glyphicons-circle-remove"></span> {'common.cancel'|devblocks_translate|capitalize}</button>
	</form>
</fieldset>
