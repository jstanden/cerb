...
<form action="#" onsubmit="return false;">
	<button type="button" onclick="genericAjaxGet('configGroup','c=config&a=handleSectionAction&section=groups&action=getGroup&id=0');"><span class="cerb-sprite2 sprite-plus-circle"></span> Add Group</button>
</form>
