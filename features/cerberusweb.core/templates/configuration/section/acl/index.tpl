...
<form>
	<button type="button" onclick="genericAjaxGet('configRole','c=config&a=handleSectionAction&section=acl&action=getRole&id=0');"><span class="glyphicons glyphicons-circle-plus" style="color:rgb(0,180,0);"></span> {'common.add'|devblocks_translate|capitalize}</button>
</form>
