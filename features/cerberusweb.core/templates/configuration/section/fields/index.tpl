...
<div id="cfTabs">
	<ul>
		...
		<li>
			<a href="{devblocks_url}ajax.php?c=config&a=handleSectionAction&section=fields&action=showFieldsTab&point={$point}&request={$response_uri|escape:'url'}{/devblocks_url}">{'common.records'|devblocks_translate|capitalize}</a>
		</li>
		<li>
