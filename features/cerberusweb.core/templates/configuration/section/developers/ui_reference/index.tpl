...
<div class="cerb-ui-page">
	...
	<div class="cerb-ui-sidebar-layout cerb-uiref-layout">
			...
			<div class="cerb-ui-sidebar--body">
				...
				<div class="cerb-ui-sidebar--section">
					...
					<ul>
						...
						<li data-target="agentprompt" data-icon="bot">AgentPrompt</li>
				...
				<div class="cerb-ui-sidebar--section">
					...
					<ul>
						...
						<li data-target="gantt" data-icon="chart-gantt">Gantt</li>
		...
		<div class="cerb-ui-sidebar-layout--content cerb-uiref-content cerb-uiref-content--code-hidden">
			...
			{include file="devblocks:cerberusweb.core::configuration/section/developers/ui_reference/components/agentprompt.tpl"}
			...
			{include file="devblocks:cerberusweb.core::configuration/section/developers/ui_reference/components/gantt.tpl"}
