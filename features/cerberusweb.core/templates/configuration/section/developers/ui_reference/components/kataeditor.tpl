...
CerbUI.KataEditor.pathToAccessor(path);     // 'ticket.group.name'  (strips /identifiers + @annotations)
                                            ...
                                            // a YAML `- ` entry adds its ordinal:  messages[0].content
