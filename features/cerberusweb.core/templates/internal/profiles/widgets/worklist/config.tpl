<div id="widget{$widget->id}Config" style="margin-top:10px;">
	<fieldset id="widget{$widget->id}Worklist" class="peek">
		...
		<div style="margin-left:10px;">
			<input type="text" name="params[render_limit]" value="{$widget->extension_params.render_limit|default:5}" class="placeholders" style="width:95%;padding:5px;border-radius:5px;" autocomplete="off" spellcheck="off">
		</div>
