<div id="widget{$widget->id}Config" style="margin-top:10px;">
	<fieldset id="widget{$widget->id}QueryEditor" class="peek">
		...
		<textarea name="params[data_query]" class="cerb-code-editor" data-editor-mode="ace/mode/twig" class="placeholders" style="width:95%;height:50px;">{$widget->extension_params.data_query}</textarea>
	...
	<fieldset id="widget{$widget->id}Columns" class="peek">
		<legend>
			Display these columns: <small>(YAML)</small>
		</legend>
		
		<textarea name="params[sheet_yaml]" class="cerb-code-editor" data-editor-mode="ace/mode/yaml" style="width:95%;height:50px;">{$widget->extension_params.sheet_yaml}</textarea>
	</fieldset>
</div>
