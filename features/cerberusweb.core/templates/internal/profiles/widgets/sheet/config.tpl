	...
	<div id="widget{$widget->id}QueryEditor" class="cerb-ui-panel cerb-ui-panel--spaced">
		...
		<div class="cerb-u-mt-3">
			<div class="cerb-ui-form--field">
				...
				<textarea name="params[placeholder_simulator_kata]" data-editor-lines="6" spellcheck="false">{$widget->extension_params.placeholder_simulator_kata}</textarea>
			</div>
	...
	var runPreviewSheet = function(ed, e) {
		...
		genericAjaxPost(formData, '', '', function(json) {
			...
			genericAjaxPost(formData, '', '', function(html) {
				...
				$sheet_preview.find('[data-cerb-sheet-column-toolbar] ul.cerb-ui-toolbar').each(function() {
