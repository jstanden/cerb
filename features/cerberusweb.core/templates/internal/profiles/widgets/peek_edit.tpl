...
{if !$model->id}
	...
	<div style="margin-bottom:5px;">
		...
		<button type="button" class="chooser-abstract" data-field-name="profile_tab_id" data-context="{CerberusContexts::CONTEXT_PROFILE_TAB}" data-single="true" data-query-required="type:&quot;cerb.profile.tab.dashboard&quot;"><span class="cerb-icons cerb-icon-search"></span></button>
