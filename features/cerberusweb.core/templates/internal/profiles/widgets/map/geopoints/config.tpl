...
"}
		...
		<textarea name="params[map_kata]" data-editor-lines="15" spellcheck="false">{$widget->extension_params.map_kata}</textarea>
	</div>
...
"}
		...
		<textarea name="params[automation][map_clicked]" data-editor-lines="15" spellcheck="false">{$widget->extension_params.automation.map_clicked}</textarea>
