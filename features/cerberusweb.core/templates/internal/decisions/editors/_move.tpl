...
<button type="button" onclick="genericAjaxPost('frmDecisionNodeMove','','',function() { window.location.reload(); });"><span class="cerb-sprite sprite-check"></span> {'common.save_changes'|devblocks_translate|capitalize}</button>
</form>
