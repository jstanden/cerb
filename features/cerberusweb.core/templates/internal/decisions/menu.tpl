<ul class="cerb-popupmenu cerb-float" style="display:block;">
	{if empty($node)}
		...
		<li><a href="javascript:;" onclick="genericAjaxPopup('export_behavior','c=internal&a=showBehaviorExportPopup&trigger_id={$trigger_id}',null,false,'500');">Export Behavior</a></li>
