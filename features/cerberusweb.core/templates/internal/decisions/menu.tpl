<ul class="cerb-popupmenu cerb-float">
	{if empty($node)}
		<li><a href="javascript:;" onclick="genericAjaxPopup('peek','c=internal&a=showDecisionPopup&trigger_id={$trigger_id}',null,false,'500');">Edit Trigger</a></li>
		<li><a href="javascript:;" onclick="genericAjaxPopup('peek','c=internal&a=showDecisionDeletePopup&trigger_id={$trigger_id}',null,false,'500');">Delete Trigger</a></li>
