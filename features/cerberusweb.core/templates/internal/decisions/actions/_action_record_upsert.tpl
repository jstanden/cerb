...
<b>{'common.query'|devblocks_translate}:</b> <i>(e.g. name:"Exact Match")</i> {include file="devblocks:cerberusweb.core::help/docs_button.tpl" url="https://cerb.ai/docs/search/"}
<div style="margin-left:10px;margin-bottom:10px;">
