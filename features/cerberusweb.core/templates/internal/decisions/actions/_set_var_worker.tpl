...
And the workers from these groups:<br>
...
Where:<br>
<label><input type="checkbox" name="{$namePrefix}[opt_logged_in]" value="1" {if $params.opt_logged_in}checked="checked"{/if}>The worker is currently logged in</label><br>
<br>