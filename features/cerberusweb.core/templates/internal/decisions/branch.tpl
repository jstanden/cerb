...
<div class="node">
	{if $node->node_type == 'switch'}
		<div class="badge badge-lightgray decision" style="margin:2px;">
	...
	{elseif $node->node_type == 'outcome'}
		<div class="badge badge-lightgray outcome">
	...
	{elseif $node->node_type == 'action'}
		<div class="badge badge-lightgray action" style="margin:2px;">
	...
	{if is_array($tree[$node_id]) && !empty($tree[$node_id])}
		<div class="branch" style="margin-left:10px;padding-left:10px;{if $node->node_type == 'outcome'}border-left:1px solid rgb(200,200,200);{/if}">
