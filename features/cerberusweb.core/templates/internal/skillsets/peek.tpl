...
<div class="buttons">
	<button type="button" class="submit" onclick="genericAjaxPopupPostCloseReloadView(null,'frmSkillsetPeek','{$view_id}', false, 'skillset_save');"><span class="cerb-sprite2 sprite-tick-circle"></span> {$translate->_('common.save_changes')|capitalize}</button>
...
<script type="text/javascript">
	...
	$popup.one('popup_open', function(event,ui) {
		$(this).dialog('option','title',"{'Skillsets'|escape:'javascript' nofilter}");
