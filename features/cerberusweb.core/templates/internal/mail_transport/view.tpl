{$view_context = CerberusContexts::CONTEXT_MAIL_TRANSPORT}
	...
	<tbody style="cursor:pointer;">
		...
		{foreach from=$view->view_columns item=column name=columns}
			...
			<td>
				...
				<button type="button" class="peek cerb-peek-trigger" data-context="{$view_context}" data-context-id="{$result.m_id}"><span class="cerb-icons cerb-icon-new-window"></span></button>
			</td>
			...
			{elseif $column == "m_extension_id"}
				<td data-column="{$column}">
					{if isset($mail_transport_exts[$result.m_extension_id])}
						{$mail_transport_exts[$result.m_extension_id]->name}
					{else}
						{$result.$column}
					{/if}
				</td>
...
$(function() {
	...
	{include file="devblocks:cerberusweb.core::internal/views/sparkline_loader.tpl" spark_module='mail_transport' spark_action='viewSparklinesJson' spark_view_id=$view->id}
	{/if}
