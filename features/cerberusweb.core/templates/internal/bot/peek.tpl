...
<div id="{$div_id}">
	...
	<div style="float:left;margin-right:10px;">
		<img src="{devblocks_url}c=avatars&context=bot&context_id={$dict->id}{/devblocks_url}?v={$dict->updated_at}" style="height:75px;width:75px;border-radius:5px;vertical-align:middle;">
	</div>
