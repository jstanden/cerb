...
<fieldset class="peek">
	...
	<table cellspacing="0" cellpadding="2" border="0" width="98%">
		...
		<tr>
			<td width="1%" nowrap="nowrap"><b>{'attachment.mime_type'|devblocks_translate}:</b></td>
			<td width="99%">
...
{include file="devblocks:cerberusweb.core::internal/custom_fieldsets/peek_custom_fieldsets.tpl" context='cerberusweb.contexts.attachment' context_id=$model->id}
...
$(function() {
	...
	$popup.one('popup_open', function(event,ui) {
		$popup.dialog('option','title',"{'Attachment'|escape:'javascript' nofilter}");
