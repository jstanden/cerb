...
<div class="help-box" style="padding:5px;border:0;">
	...
	<p>
		Click the <button type="button" class="toolbar-item"><span class="glyphicons glyphicons-cogwheel"></span></button> button and select <b>Edit Tab</b>.
	</p>
</div>
...
$(function() {
	...
	var $openEvtPopupEvent = function(e) {
		...
		if(link.substring(0,6) == 'ctx://') {
			...
			$popup = genericAjaxPopup('peek','c=internal&a=showPeekPopup&context=' + context + '&context_id=' + context_id  + '&calendar_id={$calendar->id}',null,false,'50%');
