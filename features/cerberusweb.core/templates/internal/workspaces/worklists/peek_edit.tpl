...
<table cellspacing="0" cellpadding="2" border="0" width="98%">
	...
	<tr>
		...
		<td width="99%">
			<button type="button" class="chooser-abstract" data-field-name="workspace_tab_id" data-context="{CerberusContexts::CONTEXT_WORKSPACE_TAB}" data-single="true" data-query="type:&quot;core.workspace.tab.worklists&quot;" data-autocomplete="type:&quot;core.workspace.tab.worklists&quot;" data-autocomplete-if-empty="true"><span class="cerb-icons cerb-icon-search"></span></button>
