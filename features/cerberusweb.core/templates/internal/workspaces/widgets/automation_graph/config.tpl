	...
	<div class="cerb-ui-panel cerb-ui-panel--spaced">
		...
		<div class="cerb-ui-form">
			<div class="cerb-ui-form--field">
				...
				<input type="text" name="params[automation_id]" value="{$widget->params.automation_id}" class="placeholders" autocomplete="off" spellcheck="false">
			</div>

			<div class="cerb-ui-form--field">
				<label class="cerb-ui-form--label">Height (px)</label>
				<input type="number" name="params[height]" value="{$widget->params.height|default:500}" min="150" max="2000" step="10" autocomplete="off">
			</div>

			<div class="cerb-ui-form--field">
				<label class="cerb-ui-form--label"><input type="checkbox" name="params[minimap]" value="1"{if $widget->params.minimap} checked="checked"{/if}> Show minimap</label>
			</div>
		</div>
	</div>
</div>
