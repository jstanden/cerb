<div class="dashboard-widget-title" style="margin-bottom:5px;">
	...
	<div style="float:right;display:none;" class="toolbar">
		...
		<a href="javascript:;" onclick="genericAjaxPopup('widget_edit','c=internal&a=handleSectionAction&section=dashboards&action=showWidgetPopup&widget_id={$widget->id}',null,false,'550');"><span class="cerb-sprite2 sprite-gear"></span></a>
	</div>
</div>
