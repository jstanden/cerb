<div id="widget{$widget->id}Config" style="margin-top:10px;">
	...
	<fieldset id="widget{$widget->id}Columns" class="peek">
		...
		<textarea name="params[sheet_kata]" class="cerb-sheet-yaml-editor" data-editor-mode="ace/mode/cerb_kata" style="width:95%;height:50px;">{$widget->params.sheet_kata}</textarea>
...
$(function() {
	...
	var doneFunc = function(e) {
		...
		if (e.eventData.exit === 'error') {
			...
			toolbar_editor.insertSnippet(e.eventData.return.snippet);
		}
	};
