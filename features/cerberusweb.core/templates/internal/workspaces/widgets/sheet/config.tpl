...
"
				...
				<textarea name="params[toolbar_kata]" class="cerb-toolbar-yaml-editor placeholders" data-editor-mode="ace/mode/yaml" style="width:95%;height:50px;">{$widget->params.toolbar_kata}</textarea>
