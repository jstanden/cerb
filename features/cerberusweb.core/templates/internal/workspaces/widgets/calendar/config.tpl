{$dv = $widget->params.default_view|default:'month'}
	...
	<div class="cerb-ui-panel cerb-ui-panel--spaced">
		...
		<div class="cerb-ui-form">
			<div class="cerb-ui-form--field">
				<label class="cerb-ui-form--label"><a class="cerb-chooser" data-context="{CerberusContexts::CONTEXT_CALENDAR}" data-single="true">ID</a></label>
				<input type="text" name="params[calendar_id]" value="{$widget->params.calendar_id}" class="placeholders" autocomplete="off" spellcheck="false">
			</div>
...
$(function() {
	...
	const $input = $config.find('input[name="params[calendar_id]"]');
