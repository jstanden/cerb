<div id="widget{$widget->id}Config" class="cerb-u-mt-3">
	<div id="widget{$widget->id}Behavior" class="cerb-ui-panel cerb-ui-panel--spaced">
		<div class="cerb-ui-header cerb-ui-header--tight">
			<div class="cerb-ui-header--title-sm">Event: Render workspace widget</div>
		</div>
...
"}
		...
		<textarea name="params[automations_kata]" data-editor-lines="15" spellcheck="false">{$widget->params.automations_kata}</textarea>
