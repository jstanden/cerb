...
<input type="hidden" name="section" value="community_tool">
	...
	<tbody style="cursor:pointer;">
		...
		{foreach from=$view->view_columns item=column name=columns}
			...
			<td>
				...
				<button type="button" class="peek cerb-peek-trigger" data-context="{$view_context}" data-context-id="{$result.ct_id}"><span class="glyphicons glyphicons-new-window-alt"></span></button>
			</td>
