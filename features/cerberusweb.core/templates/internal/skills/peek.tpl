...
{include file="devblocks:cerberusweb.core::internal/custom_fieldsets/peek_custom_fieldsets.tpl" context=CerberusContexts::CONTEXT_SKILL context_id=$model->id}
...
<div class="buttons">
	<button type="button" class="submit" onclick="genericAjaxPopupPostCloseReloadView(null,'frmSkillPeek','{$view_id}', false, 'skill_save');"><span class="cerb-sprite2 sprite-tick-circle"></span> {$translate->_('common.save_changes')|capitalize}</button>
...
<script type="text/javascript">
	...
	$popup.one('popup_open', function(event,ui) {
		$(this).dialog('option','title',"{'Skills'|escape:'javascript' nofilter}");
