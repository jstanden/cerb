{$view_context = CerberusContexts::CONTEXT_CURRENCY}
	...
	<tbody style="cursor:pointer;">
		...
		{foreach from=$view->view_columns item=column name=columns}
			...
			<td>
				...
				<span class="cerb-icons cerb-icon-circle-ok" style="font-size:16px;color:rgb(80,80,80);" title="{'common.default'|devblocks_translate|lower}"></span>
				{/if}
