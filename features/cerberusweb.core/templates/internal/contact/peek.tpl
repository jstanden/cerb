...
<fieldset class="peek">
	...
	<div>
		...
		<button type="button" class="cerb-peek-trigger" data-context="{CerberusContexts::CONTEXT_TICKET}" data-context-id="0" data-edit="to:{$dict->email_address}">{'mail.send_mail'|devblocks_translate|capitalize}</button>
	</div>
</fieldset>
