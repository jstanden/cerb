...
<div id="snippetTabs">
	<ul>
		...
		<li><a href="{devblocks_url}ajax.php?c=&a=&point={$point}&context={$page_context}&context_id={$page_context_id}{/devblocks_url}">{'common.content'|devblocks_translate|capitalize}</a></li>
