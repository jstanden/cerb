...
<div id="note{$note.n_id}" class="block" style="margin-bottom:10px;">
	...
	<pre class="emailBody" style="padding-top:10px;">{$note.n_content|trim|escape|devblocks_hyperlinks}</pre>
</div>
