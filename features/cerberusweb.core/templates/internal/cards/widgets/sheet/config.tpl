...
<div id="{$config_uniqid}" class="cerb-u-mt-3">
	<div id="{$config_uniqid}QueryEditor" class="cerb-ui-panel cerb-ui-panel--spaced">
		<div class="cerb-ui-header cerb-ui-header--tight cerb-ui-header--center">
			...
			<div class="cerb-ui-header--right">{include file="devblocks:cerberusweb.core::help/docs_button.tpl" url="https://cerb.ai/docs/data-queries/"}</div>
		</div>
		...
		<textarea id="widget{$widget->id}DataQuery" class="placeholders" name="params[data_query]" data-editor-lines="20" spellcheck="false">{$widget->extension_params.data_query}</textarea>
		...
		<div class="cerb-ui-form--field cerb-u-mt-2">
			<div class="cerb-u-flex cerb-u-items-center cerb-u-gap-1 cerb-u-flex-wrap">
				...
				<input type="text" maxlength="6" name="params[cache_secs]" placeholder="e.g. 300" value="{$widget->extension_params.cache_secs}" style="width:6em;flex:0 0 auto;">
		...
		<div class="cerb-u-mt-3">
			<div class="cerb-ui-form--field">
				...
				<textarea name="params[placeholder_simulator_kata]" data-editor-lines="20" spellcheck="false">{$widget->extension_params.placeholder_simulator_kata}</textarea>
			</div>

			<div class="cerb-ui-panel cerb-ui-panel--spaced cerb-u-mt-2" data-cerb-results-panel style="display:none;position:relative;">
				<span class="cerb-icons cerb-icon-circle-remove" style="position:absolute;right:0.5em;top:0.5em;cursor:pointer;z-index:1;"></span>
	...
	<div id="{$config_uniqid}Schema" class="cerb-ui-panel cerb-ui-panel--spaced">
		...
		<textarea class="cerb-sheet-yaml-editor" name="params[sheet_kata]" data-editor-lines="20" spellcheck="false">{$widget->extension_params.sheet_kata}</textarea>
	...
	<div id="{$config_uniqid}Toolbar" class="cerb-ui-panel cerb-ui-panel--spaced cerb-u-mt-3">
		<div class="cerb-ui-header cerb-ui-header--tight">
...
"
			...
			<textarea class="cerb-toolbar-yaml-editor" name="params[toolbar_kata]" data-editor-lines="20" spellcheck="false">{$widget->extension_params.toolbar_kata}</textarea>
...
$(function() {
	...
	var insertColumnSnippet = function(ed, column_type) {
		...
		if(snippet.length > 0) {
			// KataEditor.insertSnippet uses a single caret marker; flatten Ace numbered tab-stops to their defaults.
