...
class SearchFields_Contact extends DevblocksSearchFields {
	...
	static function _getFields() {
		...
		$columns = [
			...
			self::PRIMARY_EMAIL_ID => new DevblocksSearchField(self::PRIMARY_EMAIL_ID, 'contact', 'primary_email_id', $translate->_('common.email'), Model_CustomField::TYPE_NUMBER, true),
			...
			self::ORG_ID => new DevblocksSearchField(self::ORG_ID, 'contact', 'org_id', $translate->_('common.organization'), Model_CustomField::TYPE_NUMBER, true),
