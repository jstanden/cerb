...
class DAO_FileBundle extends Cerb_ORMHelper {
	...
	public static function getSearchQueryComponents($columns, $params, $sortBy=null, $sortAsc=null) {
		...
		list(, $wheres) = parent::_parseSearchParams($params, $columns, 'SearchFields_FileBundle', $sortBy);
		...
		switch($param->field) {
			...
			default:
				if(DevblocksPlatform::strStartsWith($param->field, 'cf_')) {
					...
					if(null !== ($virtual_where_sql = self::_getWhereSQLForCommonVirtual($param, CerberusContexts::CONTEXT_FILE_BUNDLE, self::getPrimaryKey())))
