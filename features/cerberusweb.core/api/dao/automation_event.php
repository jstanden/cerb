...
class SearchFields_AutomationEvent extends DevblocksSearchFields {
	...
	static function getPrimaryKey() : string {
		return sprintf('%s.%s', self::getTableName(), DAO_AutomationEvent::ID);
	}
	
	static function getUpdatedKey() : string {
		return sprintf('%s.%s', self::getTableName(), DAO_AutomationEvent::UPDATED_AT);
	}
	...
	static function getWhereSQL(DevblocksSearchCriteria $param) {
		switch($param->field) {
			...
			case self::VIRTUAL_HAS_FIELDSET:
				return self::_getWhereSQLFromFieldset($param, CerberusContexts::CONTEXT_AUTOMATION_EVENT, self::getPrimaryKey());
