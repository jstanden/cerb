		...
		switch($param->field) {
			...
			default:
				if(DevblocksPlatform::strStartsWith($param->field, 'cf_')) {
					...
					if(null !== ($virtual_where_sql = self::_getWhereSQLForCommonVirtual($param, CerberusContexts::CONTEXT_NOTIFICATION, self::getPrimaryKey())))
...
class Context_Notification extends Extension_DevblocksContext {
	...
	static function isWriteableByActor($models, $actor) {
		...
		if(!($dicts = CerberusContexts::polymorphModelsToDictionaries($models, CerberusContexts::CONTEXT_NOTIFICATION)))
			return CerberusContexts::denyEverything($models);
