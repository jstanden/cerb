...
class DAO_ProfileTab extends Cerb_ORMHelper {
	...
	public static function getSearchQueryComponents($columns, $params, $sortBy=null, $sortAsc=null) {
		...
		list($tables,$wheres) = parent::_parseSearchParams($params, $columns, 'SearchFields_ProfileTab', $sortBy);
...
//				break;
	...
	function renderCriteria($field) {
		...
		switch($field) {
			...
			case SearchFields_ProfileTab::VIRTUAL_HAS_FIELDSET:
				$this->_renderCriteriaHasFieldset($tpl, CerberusContexts::CONTEXT_PROFILE_TAB);
				break;
...
class Context_ProfileTab extends Extension_DevblocksContext implements IDevblocksContextProfile, IDevblocksContextPeek {
	...
	function renderPeekPopup($context_id=0, $view_id='', $edit=false) {
		...
		if(empty($context_id) || $edit) {
			...
			$tpl->display('devblocks:cerberusweb.core::internal/profiles/tabs/peek.tpl');
		}
	}
};
