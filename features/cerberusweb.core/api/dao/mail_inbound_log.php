...
class SearchFields_MailInboundLog extends DevblocksSearchFields {
	...
	static function _getFields() {
		...
		$columns = [
			self::CREATED_AT => new DevblocksSearchField(self::CREATED_AT, 'mail_inbound_log', 'created_at', $translate->_('common.created'), Model_CustomField::TYPE_DATE, true),
			self::FROM_ID => new DevblocksSearchField(self::FROM_ID, 'mail_inbound_log', 'from_id', $translate->_('message.header.from'), Model_CustomField::TYPE_NUMBER, true),
			self::HEADER_MESSAGE_ID => new DevblocksSearchField(self::HEADER_MESSAGE_ID, 'mail_inbound_log', 'header_message_id', $translate->_('dao.mail_log.header_message_id'), Model_CustomField::TYPE_SINGLE_LINE, true),
			self::ID => new DevblocksSearchField(self::ID, 'mail_inbound_log', 'id', $translate->_('common.id'), Model_CustomField::TYPE_NUMBER, true),
			self::MAILBOX_ID => new DevblocksSearchField(self::MAILBOX_ID, 'mail_inbound_log', 'mailbox_id', $translate->_('common.mailbox'), Model_CustomField::TYPE_NUMBER, true),
			self::MESSAGE_ID => new DevblocksSearchField(self::MESSAGE_ID, 'mail_inbound_log', 'message_id', $translate->_('common.message'), Model_CustomField::TYPE_NUMBER, true),
			self::PARSE_TIME_MS => new DevblocksSearchField(self::PARSE_TIME_MS, 'mail_inbound_log', 'parse_time_ms', $translate->_('dao.mail_log.parse_time_ms'), Model_CustomField::TYPE_NUMBER, true),
			self::STATUS_ID => new DevblocksSearchField(self::STATUS_ID, 'mail_inbound_log', 'status_id', $translate->_('common.status'), Model_CustomField::TYPE_NUMBER, true),
			self::STATUS_MESSAGE => new DevblocksSearchField(self::STATUS_MESSAGE, 'mail_inbound_log', 'status_message', $translate->_('dao.mail_log.status_message'), Model_CustomField::TYPE_SINGLE_LINE, true),
			self::SUBJECT => new DevblocksSearchField(self::SUBJECT, 'mail_inbound_log', 'subject', $translate->_('message.header.subject'), Model_CustomField::TYPE_SINGLE_LINE, true),
			self::TICKET_ID => new DevblocksSearchField(self::TICKET_ID, 'mail_inbound_log', 'ticket_id', $translate->_('common.ticket'), Model_CustomField::TYPE_NUMBER, true),
			self::TO => new DevblocksSearchField(self::TO, 'mail_inbound_log', 'to', $translate->_('message.header.to'), Model_CustomField::TYPE_SINGLE_LINE, true),
