...
class DAO_Currency extends Cerb_ORMHelper {
	...
	public static function getSearchQueryComponents($columns, $params, $sortBy=null, $sortAsc=null) {
		...
		array_walk_recursive(
			$params,
			array('DAO_Currency', '_translateVirtualParameters'),
			$args
		);
	...
	private static function _translateVirtualParameters($param, $key, &$args) {
		...
		$from_context = CerberusContexts::CONTEXT_CURRENCY;
		$from_index = 'currency.id';
...
//				break;
	...
	function renderCriteria($field) {
		...
		switch($field) {
			...
			case SearchFields_Currency::VIRTUAL_HAS_FIELDSET:
				$this->_renderCriteriaHasFieldset($tpl, CerberusContexts::CONTEXT_CURRENCY);
				break;
