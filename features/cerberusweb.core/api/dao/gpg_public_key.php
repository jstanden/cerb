...
class DAO_GpgPublicKey extends Cerb_ORMHelper {
	...
	public static function getSearchQueryComponents($columns, $params, $sortBy=null, $sortAsc=null) {
		...
		array_walk_recursive(
			$params,
			array('DAO_GpgPublicKey', '_translateVirtualParameters'),
			$args
		);
	...
	private static function _translateVirtualParameters($param, $key, &$args) {
		...
		$from_context = CerberusContexts::CONTEXT_GPG_PUBLIC_KEY;
		$from_index = 'gpg_public_key.id';
...
//				break;
	...
	function renderCriteria($field) {
		...
		switch($field) {
			...
			case SearchFields_GpgPublicKey::VIRTUAL_HAS_FIELDSET:
				$this->_renderCriteriaHasFieldset($tpl, CerberusContexts::CONTEXT_GPG_PUBLIC_KEY);
				break;
