<?php
class Toolbar_RecordsWorklistSearch extends Extension_Toolbar {
	const ID = 'cerb.toolbar.records.worklist.search';
	...
	function getInteractionOutputMeta(): array {
		return [
			[
				'key' => 'query',
				'notes' => 'A search query to place in the quick-search field and run.',
			],
		];
	}
