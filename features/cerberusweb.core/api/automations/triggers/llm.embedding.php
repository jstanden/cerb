<?php
class AutomationTrigger_LlmEmbedding extends Extension_AutomationTrigger {
	const ID = 'cerb.trigger.llm.embedding';
	...
	function getInputsMeta() {
		return [
			[
				'key' => 'texts',
				'notes' => 'A list of text blocks to return embeddings for.',
			],
		];
	}
	...
	function getOutputsMeta() {
		return [
			'return' => [
				[
					'key' => 'embeddings',
					'notes' => 'A list of vector embeddings (one per input).',
					'required' => true,
				],
			],
		];
