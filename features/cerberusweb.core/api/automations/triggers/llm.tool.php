<?php
class AutomationTrigger_LlmTool extends Extension_AutomationTrigger {
	const ID = 'cerb.trigger.llm.tool';
	...
	function getOutputsMeta() {
		return [
			'return' => [
				[
					'key' => 'content',
					'notes' => 'The results of the tool execution for the given inputs.',
					'required' => true,
				],
			],
		];
