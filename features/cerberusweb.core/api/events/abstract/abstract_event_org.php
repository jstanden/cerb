...
abstract class AbstractEvent_Org extends Extension_DevblocksEvent {
	...
	function simulateActionExtension($token, $trigger, $params, &$values) {
		...
		switch($token) {
			case 'add_watchers':
				return DevblocksEventHelper::simulateActionAddWatchers($params, $values, 'org_id');
				break;
			
			case 'create_comment':
				return DevblocksEventHelper::simulateActionCreateComment($params, $values, 'org_id');
				break;
				
			case 'create_notification':
				return DevblocksEventHelper::simulateActionCreateNotification($params, $values, 'org_id');
				break;
				
			case 'create_task':
				return DevblocksEventHelper::simulateActionCreateTask($params, $values, 'org_id');
				break;

			case 'create_ticket':
				return DevblocksEventHelper::simulateActionCreateTicket($params, $values, 'org_id');
				break;
			...
			default:
				if('set_cf_' == substr($token,0,7)) {
					...
					if(!empty($context) && !empty($context_id))
						return DevblocksEventHelper::simulateActionSetCustomField($custom_field, 'org_custom', $params, $values, $context, $context_id);
				}
				break;	
		}
	}
	...
	function runActionExtension($token, $trigger, $params, &$values) {
		...
		switch($token) {
			case 'add_watchers':
				DevblocksEventHelper::runActionAddWatchers($params, $values, 'org_id');
				break;
			
			case 'create_comment':
				DevblocksEventHelper::runActionCreateComment($params, $values, 'org_id');
				break;
				
			case 'create_notification':
				DevblocksEventHelper::runActionCreateNotification($params, $values, 'org_id');
				break;
				
			case 'create_task':
				DevblocksEventHelper::runActionCreateTask($params, $values, 'org_id');
				break;

			case 'create_ticket':
				DevblocksEventHelper::runActionCreateTicket($params, $values, 'org_id');
				break;
