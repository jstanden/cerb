...
abstract class AbstractEvent_AjaxHttpRequest extends Extension_DevblocksEvent {
	...
	function getConditionExtensions(Model_TriggerEvent $trigger) {
		...
		$labels['bot_link'] = 'Bot is linked';
		$labels['bot_watcher_count'] = 'Bot watcher count';
	...
	function renderConditionExtension($token, $as_token, $trigger, $params=[], $seq=null) {
		...
		switch($as_token) {
			case 'http_header':
				$tpl->display('devblocks:cerberusweb.core::events/ajax/condition_http_header.tpl');
				break;
				
			case 'http_param':
				$tpl->display('devblocks:cerberusweb.core::events/ajax/condition_http_param.tpl');
				break;
	...
	function renderActionExtension($token, $trigger, $params=[], $seq=null) {
		...
		switch($token) {
			case 'set_http_header':
				$tpl->display('devblocks:cerberusweb.core::events/ajax/action_set_http_header.tpl');
				break;
				
			case 'set_http_body':
				$tpl->display('devblocks:cerberusweb.core::events/ajax/action_set_http_body.tpl');
				break;
				
			case 'set_http_status':
				$tpl->display('devblocks:cerberusweb.core::events/ajax/action_set_http_status.tpl');
				break;
	...
	function simulateActionExtension($token, $trigger, $params, DevblocksDictionaryDelegate $dict) {
		...
		switch($token) {
			...
			case 'add_watchers':
				return DevblocksEventHelper::simulateActionAddWatchers($params, $dict, 'bot_id');
				break;
	...
	function runActionExtension($token, $trigger, $params, DevblocksDictionaryDelegate $dict) {
		...
		switch($token) {
			...
			case 'add_watchers':
				DevblocksEventHelper::runActionAddWatchers($params, $dict, 'bot_id');
				break;
