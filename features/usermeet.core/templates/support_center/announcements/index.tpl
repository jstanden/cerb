...
{if !empty($feeds)}
	...
	<div class="feed">
		<div class="header">
			{if !empty($feed.url)}
			<a href="{$feed.url|escape}" target="_blank"><img src="{devblocks_url}c=resource&p=usermeet.core&f=images/feed-icon-16x16.gif{/devblocks_url}" alt="RSS" align="top" border="0"></a>
			{/if}
