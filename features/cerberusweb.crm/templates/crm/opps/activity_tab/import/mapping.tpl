...
<button type="button" onclick="document.location='{devblocks_url}c=activity&a=opps{/devblocks_url}';"><span class="cerb-sprite sprite-delete"></span> {$translate->_('common.cancel')|capitalize}</button>
<br>
</form>
</div>
<br>
