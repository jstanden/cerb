...
<button type="button" onclick="document.location='{devblocks_url}c=activity&a=opps{/devblocks_url}';"><span class="cerb-sprite2 sprite-cross-circle-frame"></span> {$translate->_('common.cancel')|capitalize}</button>
<br>
</form>
</div>
<br>
