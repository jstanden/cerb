	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%">
		<tr>
			<td width="1%" nowrap="nowrap">
				<button id="btnQuickCompose" type="button" onclick="genericAjaxPanel('c=tickets&a=showComposePeek&view_id={$view->id}&to={$address->email|escape:'url'}',null,false,'600');"><img src="{devblocks_url}c=resource&p=cerberusweb.core&f=images/export2.png{/devblocks_url}" align="top"> {'mail.send_mail'|devblocks_translate}</button>
			</td>
			<td width="98%"></td>
