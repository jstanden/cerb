{$view_context = CerberusContexts::CONTEXT_WEBHOOK_LISTENER}
		...
		{foreach from=$view->view_columns item=column name=columns}
			...
			{elseif $column == "*_sparkline"}
				<td data-column="{$column}" style="width:160px;">
					<div class="cerb-ui-sparkchart" data-cerb-spark="{$result.w_id}" style="min-width:140px;"></div>
				</td>
			{else}
...
{include file="devblocks:cerberusweb.core::internal/views/sparkline_loader.tpl" spark_module='webhook_listener' spark_action='viewSparklinesJson' spark_view_id=$view->id spark_tooltip_labels=true}
{/if}
