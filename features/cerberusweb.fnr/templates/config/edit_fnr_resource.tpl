...
<table cellpadding="2" cellspacing="0" border="0">
	...
	<tr>
		<td colspan="2">
			...
			{if !empty($fnr_resource)}<button type="button" onclick="if(confirm('Are you sure you want to delete this resource?')){literal}{{/literal}this.form.do_delete.value=1;this.form.submit();{literal}}{/literal}"><span class="cerb-sprite sprite-delete2"></span> {$translate->_('common.delete')|capitalize}</button>{/if}
		</td>
	</tr>
</table>
</div>