...
<button type="button" id="btnSubmit" onclick="genericAjaxPost('frmRange', 'reportGroupReplies');drawChart(document.getElementById('start').value, document.getElementById('end').value);">{$translate->_('common.refresh')|capitalize}</button>
...
<div id="reportGroupReplies" style="background-color:rgb(255,255,255);"></div>
<script language="javascript" type="text/javascript">
{literal}	
