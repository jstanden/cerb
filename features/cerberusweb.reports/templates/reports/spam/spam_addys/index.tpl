	...
	<tr>
		<td width="50%" align="center" valign="top">
			...
			<table cellpadding="5" cellspacing="0">
				...
				<tr>
					<td><a href="javascript:;" onclick="genericAjaxPopup('peek','c=contacts&a=showAddressPeek&email={$email|escape:'url'}&view_id={$view->id}',null,false,'500');" title="{$email|escape}">{$email|truncate:45|escape}</td>
