...
<button type="button" id="btnSubmit" onclick="genericAjaxPost('frmRange', 'reportWorkerReplies');drawChart(document.getElementById('start').value, document.getElementById('end').value);">{$translate->_('common.refresh')|capitalize}</button>
