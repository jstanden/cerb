...
class CerberusApplication extends DevblocksApplication {
	...
	static function checkRequirements() : array {
		...
		if(version_compare(PHP_VERSION,"8.5") < 0) {
			$errors[] = sprintf("Cerb %s requires PHP 8.5 or later. Your server PHP version is %s",
				APP_VERSION,
				PHP_VERSION
			);
		}
	...
	static function generateTicketMask($pattern = null) {
		...
		$numbers = "123456789";
		$denylist_3ltr = 'ANL|ASS|BBW|BLO|BUT|CMN|CNT|COC|COK|COQ|CUM|DIC|DIK|DIQ|FAG|FAT|FME|FML|FNU|FUK|FUQ|GAG|GAY|GFY|JAP|JIZ|JUG|JZZ|KKK|KOK|MLF|MUF|NGR|NIG|NIP|PDO|PED|PEE|PEG|PMS|POO|PUS|RIM|SEX|SHT|SMN|SNM|SUC|SUK|SUX|SXY|TIT|VAG|WET|WTF|XXX';
...
class CerberusLicense {
	...
	public static function getReleases() {
		/*																																																																																																	*/if(1>0) return json_decode(base64_decode(''),true);/*
		...
		return [
			...
			'11.1.0' => gmmktime(0,0,0,3,31,2025),
			'11.2.0' => gmmktime(0,0,0,9,30,2025),
		];
	}
